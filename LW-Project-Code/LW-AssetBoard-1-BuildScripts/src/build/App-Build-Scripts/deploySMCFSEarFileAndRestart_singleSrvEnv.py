def getOptions(cellName, nodeName, appInfo, ctxRoot = None):
    options = [ '-nopreCompileJSPs',
				...
				'-MapModulesToServers', [['.*', '.*', 'WebSphere:cell='+cellName+',node='+nodeName+',server='+appInfo["webserverName"]+'+WebSphere:cell='+cellName+',cluster='+appInfo["cluster"]]]
            ]
    if ctxRoot != None:
...
if __name__ == '__main__':    
    ...
    options = getOptions(cellName, appInfo["nodeName"], appInfo)
