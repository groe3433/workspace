...
then
	...
	echo "Entered TOGSystemStats Order Line Stats..." >> /opt/ssfs/runtime/logs/TOGSystemStats.log;
	...
	Script1="TOG-OrderLineStats.sql";
	...
	echo $StdOut | sed -e 's/newLine /\n/g' -e 's/newLine//g' | mailx -s "TOGSystemStats Order Line Stats" $MORE_DETAILED_EMAIL;

	echo "Exiting TOGSystemStats Order Line Stats..." >> /opt/ssfs/runtime/logs/TOGSystemStats.log;
