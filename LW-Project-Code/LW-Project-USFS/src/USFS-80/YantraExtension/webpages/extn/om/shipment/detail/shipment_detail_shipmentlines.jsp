...
<%
	...
	//added for CR 506
	String sConfirmFlag = resolveValue("xml:/Shipment/@ConfirmFlag");
	//System.out.println("sConfirmFlag " + sConfirmFlag);
...
<tr>
	...
	<!-- Begin CR383 -->
        <td class=tablecolumnheader sortable="yes" style="width:<%=getUITableSize("xml:/Shipment/ShipmentLines/ShipmentLine/@OrderType")%>">
...
<%	String orderHeaderKey = resolveValue("xml:/ShipmentLine/@OrderHeaderKey");
	if(equals("0",resolveValue("xml:ShipmentLine:/ShipmentLine/@ShipmentSubLineNo"))){
			if(bAppendOldValue) {
    ...
    <tr>
       ...
       <td class="numerictablecolumn">
        ...
        <td class="tablecolumn">
                         <yfc:getXMLValue  name="ShipmentLine" binding="xml:/ShipmentLine/@OrderType"/>
        </td>
        <!-- End CR383 -->
...
<%		}	%>
	   ...
	   <td class="numerictablecolumn">
	   	<!-- BEGIN Manish K
		   The following line is commented and another line is added to show the ordered quantity from order line in the original quantity column for CR-820
		   This workaround is under the assumption that an orderline will not split across multiple shipments
            <yfc:getXMLValue  name="ShipmentLine" binding="xml:/ShipmentLine/@OriginalQuantity"/> 
           END -->
            <yfc:getXMLValue  name="ShipmentLine" binding="xml:/ShipmentLine/OrderLine/@OrderedQty"/>
       </td>
	<%}else{%>
	   <td class="numerictablecolumn">
...
<%			}	%>
	...
	<% //added for CR 506  
	if(!sConfirmFlag.equalsIgnoreCase("Y")) {%>
	<tr>
