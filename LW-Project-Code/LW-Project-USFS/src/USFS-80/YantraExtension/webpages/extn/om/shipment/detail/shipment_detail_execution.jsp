...
<table width="100%" class="view">
	...
	<tr>
 	...
 	<td  class="protectedtext">
		<a 		  
onclick="yfcShowListPopupWithParams('', '', '900', '500', '', 'wave',encodeURI('&xml:/Wave/@ShipmentNo='+document.all('xml:/Shipment/@ShipmentNo').value+'&xml:/Wave/@Node='+document.all('xml:/Shipment/@ShipNode').value));return false;" href="">
