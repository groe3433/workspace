...
<%@ include file="/om/order/detail/order_detail_orderlines_include.jspf" %>
...
<%	}	else	if (equals(getValue("OrderLine","xml:/OrderLine/@CanAddServiceLines"),"Y")
...
<% }%>
<% if (equals(getValue("OrderLine","xml:/OrderLine/@AwaitingDeliveryRequest"),"Y")
&& ! equals(getValue("Order","xml:/Order/@isHistory"),"Y")) { %>
...
<td class="checkboxcolumn">
<img class="icon" onclick="setDeleteOperation(this)" <%=getImageOptions(YFSUIBackendConsts.DELETE_ICON, "Remove_Row")%>/>
</td>
<td class="tablecolumn">
