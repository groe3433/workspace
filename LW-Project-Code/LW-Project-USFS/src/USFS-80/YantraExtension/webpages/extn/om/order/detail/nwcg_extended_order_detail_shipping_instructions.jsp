...
<tr>
	...
	<%if (navInfo.equals("NAV_INST")){%>    
		<%if (canBeModified) {%>
		<td colspan="1" align="left" > 
			<select class="combobox" <%=yfsGetComboOptions("xml:/Order/Extn/@ExtnShipInstrState", "xml:/Order/Extn/@ExtnShipInstrState", "xml:/Order/AllowedModifications")%>>
				<yfc:loopOptions binding="xml:CommonStateCodeList:/CommonCodeList/@CommonCode" name="CodeShortDescription" value="CodeValue" 
				selected="xml:/Order/Extn/@ExtnShipInstrState" isLocalized="Y"/>
			</select>
