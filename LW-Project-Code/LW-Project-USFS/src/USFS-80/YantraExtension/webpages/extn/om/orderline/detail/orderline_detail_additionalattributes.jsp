...
<td>
<input type="text" <%=yfsGetTextOptions("xml:/Order/OrderLines/OrderLine/LinePriceInfo/@UnitPrice", "xml:/OrderLine/LinePriceInfo/@UnitPrice", "xml:/OrderLine/AllowedModifications")%> readonly>
</td>
<td class="detaillabel" >
<yfc:i18n>List_Price</yfc:i18n>
</td>
<td>
<input type="text" <%=yfsGetTextOptions("xml:/Order/OrderLines/OrderLine/LinePriceInfo/@ListPrice", "xml:/OrderLine/LinePriceInfo/@ListPrice", "xml:/OrderLine/AllowedModifications")%> readonly>
</td>
<td class="detaillabel" >
<yfc:i18n>Retail_Price</yfc:i18n>
</td>
<td>
<input type="text" <%=yfsGetTextOptions("xml:/Order/OrderLines/OrderLine/LinePriceInfo/@RetailPrice", "xml:/OrderLine/LinePriceInfo/@RetailPrice", "xml:/OrderLine/AllowedModifications")%> readonly>
</td>
</tr>
<tr>
