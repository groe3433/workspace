...
<%
//System.out.println("%%%%%%%%%%%%%%%%%%%%"+(String)request.getAttribute("associationKey"));
%>
...
<yfc:getXMLValue binding="xml:/CurrencyList/Currency/@PrefixSymbol"/>&nbsp;<yfc:getXMLValue binding="xml:ServiceLine:/OrderLine/LinePriceInfo/@LineTotal"/>&nbsp;<yfc:getXMLValue binding="xml:/CurrencyList/Currency/@PostfixSymbol"/>
</td>
<td class="tablecolumn">
