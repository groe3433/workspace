...
<table class="table" ID="OrderLines" cellspacing="0" width="100%" yfcMaxSortingRecords="1000" >
    <thead>
        <tr>
            ...
            <td class="tablecolumnheader" nowrap="true" sortable="no" style="width:100px"><yfc:i18n>Supplier_Std_Pack</yfc:i18n></td>
            <td class="tablecolumnheader" nowrap="true" sortable="no" style="width:40px"><yfc:i18n>Supplier_UOM</yfc:i18n></td>
			...
			<td class="tablecolumnheader" style="width:100px"><yfc:i18n>Standard_Pack</yfc:i18n></td>
