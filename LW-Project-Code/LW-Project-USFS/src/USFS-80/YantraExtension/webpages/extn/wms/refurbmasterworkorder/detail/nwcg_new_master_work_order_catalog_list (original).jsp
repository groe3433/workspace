 ...
 <table class="table" ID="WorkOrderComponents" cellspacing="0" width="100%" GenerateID="true">
	...
	<tbody>
		...
		<tr TemplateRow="false" style="display:all;">
			...
			<td nowrap="true" class="tablecolumn" style="width:50px">
				<input type="text" class="unprotectedinput"  style="width:50px" 
					onBlur="fetchDataWithParams(this,'ComputePriceForItem',setPriceForItem,setPricingParams(this))"  
					<%=getTextOptions("xml:/WorkOrder/WorkOrderComponents/WorkOrderComponent_"+count+"/@ComponentQuantity")%>/>
				<br>
			</td>
			<td nowrap="true" class="tablecolumn" style="width:50px">
			...
			<td nowrap="true" class="tablecolumn" style="width:50px"> 
				<input type="text" class="unprotectedinput"  style="width:50px" <%=getTextOptions("xml:/WorkOrder/WorkOrderComponents/WorkOrderComponent_"+count+"/Extn/@RefurbCost")%>/>
	...
	<tfoot>
		<tr TemplateRow="true" style="display:none;">
			...
			<td nowrap="true" class="tablecolumn" style="width:50px">
				<input type="text" class="unprotectedinput"  style="width:50px" 
					onBlur="fetchDataWithParams(this,'ComputePriceForItem',setPriceForItem,setPricingParams(this))"  
					<%=getTextOptions("xml:/WorkOrder/WorkOrderComponents/WorkOrderComponent_/@ComponentQuantity")%>/>
				<br>
			</td>
			<td nowrap="true" class="tablecolumn" style="width:50px">
			...
			<td nowrap="true" class="tablecolumn" style="width:50px"> 
				<input type="text" class="unprotectedinput"  style="width:50px" <%=getTextOptions("xml:/WorkOrder/WorkOrderComponents/WorkOrderComponent_/Extn/@RefurbCost")%>/>
