...
<%
	...
	System.out.println("@@@@@ MasterWorkOrderKey : " + MasterWorkOrderKey);
	String MasterWorkOrderLineKey = resolveValue("xml:/NWCGMasterWorkOrderLine/@MasterWorkOrderLineKey");
	System.out.println("@@@@@ MasterWorkOrderLineKey : " + MasterWorkOrderLineKey);
...
<table class="table" ID="NWCGBillingTransactionList" cellspacing="0" width="50%" GenerateID="true">
	...
	<tbody>
			<%
				...
				System.out.println("@@@@@ nlComponent.getLength() : " + nlComponent.getLength());
