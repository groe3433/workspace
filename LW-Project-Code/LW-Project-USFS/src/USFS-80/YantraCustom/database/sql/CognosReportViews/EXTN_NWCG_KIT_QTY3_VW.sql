CREATE OR REPLACE FORCE VIEW EXTN_NWCG_KIT_QTY3_VW ("CACHE_ID", "COMPONENT_ITEM", "PARENT1", "KIT_QTY1", "PARENT2", "KIT_QTY2", "PARENT3", "KIT_QTY3", "QTY_KITS3")
AS
  SELECT a.organization_code "CACHE_ID",
    ...
    AND b1.item_id              = parent3.item_id
    ...
    )                           * y.kit_qty1 * y.kit_qty2 * ki3.kit_quantity) "QTY_KITS3"
  FROM
