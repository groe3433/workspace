 ...
 *         &lt;element name="DispatchFromAndTo" type="{http://nwcg.gov/services/ross/common_types/1.1}DispatchUnitFromAndTo"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "TransferIncidentNotification")
public class TransferIncidentNotification {
    ...
    @XmlElement(name = "DispatchFromAndTo", required = true)
    protected DispatchUnitFromAndTo dispatchFromAndTo;
    ...
    /**
     * Gets the value of the dispatchFromAndTo property.
     * 
     * @return
     *     possible object is
     ...
     *     
     */
    public DispatchUnitFromAndTo getDispatchFromAndTo() {
        return dispatchFromAndTo;
    }

    /**
     * Sets the value of the dispatchFromAndTo property.
     * 
     * @param value
     *     allowed object is
     *     {@link DispatchUnitFromAndTo }
     *     
     */
    public void setDispatchFromAndTo(DispatchUnitFromAndTo value) {
        this.dispatchFromAndTo = value;
    }

    public boolean isSetDispatchFromAndTo() {
        return (this.dispatchFromAndTo!= null);
    }
