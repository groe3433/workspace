 ...
 *         &lt;element name="EntityID" type="{http://nwcg.gov/services/ross/common_types/1.1}EntityIDSimpleType"/>
...
@XmlType(name = "IDType", namespace = "http://nwcg.gov/services/ross/common_types/1.1", propOrder = {
    "entityType",
    "entityID",
    "applicationSystem"
})
