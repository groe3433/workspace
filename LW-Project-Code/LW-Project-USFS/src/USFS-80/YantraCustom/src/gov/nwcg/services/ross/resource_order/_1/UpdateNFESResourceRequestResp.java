 ...
 *         &lt;element name="RequestKey" type="{http://nwcg.gov/services/ross/common_types/1.1}CompositeResourceRequestKeyType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "UpdateNFESResourceRequestResp")
public class UpdateNFESResourceRequestResp {

    @XmlElement(name = "ResponseStatus", required = true)
    protected ResponseStatusType responseStatus;
    @XmlElement(name = "RequestKey")
    protected List<CompositeResourceRequestKeyType> requestKey;
     ...
     * This is why there is not a <CODE>set</CODE> method for the requestKey property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getRequestKey().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<CompositeResourceRequestKeyType> getRequestKey() {
        if (requestKey == null) {
            requestKey = new ArrayList<CompositeResourceRequestKeyType>();
        }
        return this.requestKey;
    }

    public boolean isSetRequestKey() {
        return ((this.requestKey!= null)&&(!this.requestKey.isEmpty()));
    }
