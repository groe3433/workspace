...
<%
	...
	// check the mod, if the total number of records is in multiples of maximum records we dont have to add a page explictly as the remainder will be zero
...
%>
		...
		%> 
		-->
		<input type=button value='New' name="New" onClick="addBlankRows_CreateCacheRequest(this);"/>
		</td>
