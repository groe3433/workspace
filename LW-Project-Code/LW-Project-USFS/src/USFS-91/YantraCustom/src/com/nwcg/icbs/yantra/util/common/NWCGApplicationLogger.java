...
public class NWCGApplicationLogger extends YFCLogCategory {
	
	protected static YFCLogCategory logger = null;
	protected static NWCGApplicationLogger nlogger = null;
	
	protected NWCGApplicationLogger(String name) {
		super(name);
	}
	...
	public static NWCGApplicationLogger instance(String name)
	{
		if ( logger == null ) {
			...
			if ( agentServer != null ) {
				...
				logger =  YFCLogCategory.instance("NWCGApplicationLogger");
				nlogger = new NWCGApplicationLogger("NWCGApplicationLogger");
				logger.verbose("Set logger to NWCGApplicationLogger");
			}
		}
	    return nlogger;
	}
