...
public class NWCGUpdateShipNodeAccountCodes implements YIFCustomApi {
	...
	private static YFCLogCategory logger = NWCGApplicationLogger
			.instance(NWCGUpdateShipNodeAccountCodes.class);
	...
	public Document modifyShipNodeAccountCodes(YFSEnvironment env, Document inXML) throws Exception {
		...
		logger.debug("@@@@@ getOrganizationList_inXML : " + XMLUtil.getXMLString(getOrganizationList_inXML));
		...
		logger.debug("@@@@@ getOrganizationList_outXML : " + XMLUtil.getXMLString(getOrganizationList_outXML));
