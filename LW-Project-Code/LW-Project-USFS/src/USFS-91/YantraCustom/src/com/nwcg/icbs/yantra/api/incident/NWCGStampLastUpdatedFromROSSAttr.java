...
public class NWCGStampLastUpdatedFromROSSAttr implements YIFCustomApi {
	...
	public Document stampLastUpdatedFromROSSAttr(YFSEnvironment environment,
			Document document) throws Exception {

		GregorianCalendar gregorianCalendar = new GregorianCalendar();
		XMLGregorianCalendar xmlGregorialCal = DatatypeFactory.newInstance()
				.newXMLGregorianCalendar(gregorianCalendar);
		String calStr = xmlGregorialCal.toString();
		document.getDocumentElement().setAttribute("LastUpdatedFromROSS",
				calStr);
