CREATE OR REPLACE FORCE VIEW EXTN_NWCG_ENT_ITEM_SUMMARY_VW ("INCIDENT_NO", "INCIDENT_NAME", "YEAR", "CACHE_ITEM", "DESCRIPTION", "UOM", "ITEM_CLASSIFICATION", "ITEM_GROUP", "QTY_ISSUED", "QTY_TRANSFERRED_IN", "TOTAL_ISSUED", "TOTAL_ISSUED_VALUE", "QTY_RETURNED", "TOTAL_RETURNED_VALUE", "QTY_TRANSFERRED_OUT", "TOTAL_RETURNED", "TOTAL_QTY_WO", "TOTAL_QTY_UNS", "TOTAL_UNS_VALUE", "TOTAL_OUTSTANDING", "UNIT_PRICE", "COST_OUTSTANDING", "LOSS_USE_ACTUAL", "ORDER_NO", "FS_ACCT_CODE", "BLM_ACCT_CODE", "OVERRIDE_CODE", "OTHER_ACCT_CODE")
AS
  SELECT incident_no,
    INCIDENT_NAME,
    YEAR,
  ...
  FROM
    (SELECT incident_no,
      ...
      QTY_RETURNED,
      ((QTY_RETURNED+TOTAL_QTY_WO)*unit_price) "TOTAL_RETURNED_VALUE",
      QTY_TRANSFERRED_OUT,
      TOTAL_RETURNED,
      TOTAL_QTY_WO,
      TOTAL_QTY_UNS,
      (TOTAL_QTY_UNS*unit_price) "TOTAL_UNS_VALUE",
    ...
    FROM
      ...
      FROM
        ...
        FROM
          ...
          FROM EXTN_NWCG_ENT_INCDT_RPT_SUM_VW rpt,
            yfs_item item,
