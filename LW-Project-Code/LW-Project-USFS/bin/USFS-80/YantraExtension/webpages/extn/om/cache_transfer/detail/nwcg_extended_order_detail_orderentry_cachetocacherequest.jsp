...
<input class="protectedtext" readonly="true" <%=getTextOptions("xml:/Order/@ReceivingNode","xml:CurrentUser:/User/@Node")%>/>
<!-- END 2.1 Enhancement READ ONLY SHIP CACHE ID -->
</td>

<td class="detaillabel" ><yfc:i18n>Shipping_Cache</yfc:i18n></td>
<td nowrap="true">
<input type="text" class="unprotectedinput" <%=getTextOptions("xml:/Order/@ShipNode")%> id="xml:/Order/@ShipNode" onblur="javascript:fetchDataWithParams(this,'getAccountCodes',updateAccountCodes,setParam(document.getElementById('xml:/Order/@ShipNode')));"/>
