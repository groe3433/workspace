...
//System.out.println("strUserNode -->"+strUserNode);
String incidentKeyVal = resolveValue("xml:/NWCGIncidentOrder/@IncidentKey");
//System.out.println("incidentKeyVal -->"+incidentKeyVal);
String extnIncidentNo = resolveValue("xml:/Order/Extn/@ExtnIncidentNo");
//System.out.println("extnIncidentNo -->"+extnIncidentNo);
String extnIncidentYr = resolveValue("xml:/Order/Extn/@ExtnIncidentYear");
//System.out.println("extnIncidentYr -->"+extnIncidentYr);
// Default the billto ID if it's passed from the previous popup screen
...
//System.out.println("DocumentType:" + strDocumentType);
...
//System.out.println("incident year: " + extnIncidentYear);
%>
...
<input type="text" class="unprotectedinput" onBlur="setRequestDeliverDate(this);setExtnReqDelDateInDiffPanels(this, 'xml:/Order/Extn/@TestExtnReqDeliveryDate_YFCDATE')" <%=getTextOptions("xml:/Order/Extn/@ExtnReqDeliveryDate_YFCDATE")%>/>
<img class="lookupicon" onclick="invokeCalendar(this);return false" <%=getImageOptions(YFSUIBackendConsts.DATE_LOOKUP_ICON, "Calendar")%>/>
<input type="text" class="unprotectedinput"  onBlur="setExtnReqDelDateInDiffPanels(this, 'xml:/Order/Extn/@TestExtnReqDeliveryDate_YFCTIME')" <%=getTextOptions("xml:/Order/Extn/@ExtnReqDeliveryDate_YFCTIME")%>/>
<img class="lookupicon" onclick="invokeTimeLookup(this);return false" <%=getImageOptions(YFSUIBackendConsts.TIME_LOOKUP_ICON, "Time_Lookup")%>/>
