...
<tr>
    <td class="searchlabel" ><yfc:i18n>Order By</yfc:i18n></td>
</tr>
<tr>
    <td nowrap="true" class="searchcriteriacell" >
       <select class=combobox name=xml:/NWCGBillingTransaction/@OrderBy > 
	     <option value="" Selected></option> 
	     <option value="TransactionNo">Transaction No</option> 
		 <option value="TransType">Trans Type</option>
		 <option value="IncidentBlmAcctCode">BLM Account Code</option>
		 <option value="TransAmount">Trans Amount</option>
