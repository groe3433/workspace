...
<td class="protectednumber"><yfc:getXMLValue binding="xml:/CurrencyList/Currency/@PrefixSymbol"/> <%=getValue("Order","xml:/Order/ChargeTransactionDetails/@TotalCredits")%> <yfc:getXMLValue binding="xml:/CurrencyList/Currency/@PostfixSymbol"/></td>
<td class="detaillabel" ><yfc:i18n>Amount_Invoiced_Debits</yfc:i18n></td>
<td class="protectednumber"><yfc:getXMLValue binding="xml:/CurrencyList/Currency/@PrefixSymbol"/> <%=getValue("Order","xml:/Order/ChargeTransactionDetails/@TotalDebits")%> <yfc:getXMLValue binding="xml:/CurrencyList/Currency/@PostfixSymbol"/></td>
</tr>
<tr>
<td class="detaillabel" ><yfc:i18n>Total_Refunded</yfc:i18n></td>
<td class="protectednumber"><yfc:getXMLValue binding="xml:/CurrencyList/Currency/@PrefixSymbol"/> <%=getValue("Order", "xml:/Order/ChargeTransactionDetails/@TotalRefunds")%>
<yfc:getXMLValue binding="xml:/CurrencyList/Currency/@PostfixSymbol"/></td>
<td class="detaillabel" ><yfc:i18n>Return_Invoiced_Amount</yfc:i18n></td>
<td class="protectednumber"><yfc:getXMLValue binding="xml:/CurrencyList/Currency/@PrefixSymbol"/> <%=getValue("Order", "xml:/Order/ChargeTransactionDetails/@TotalReturnOrderAmount")%>
<yfc:getXMLValue binding="xml:/CurrencyList/Currency/@PostfixSymbol"/></td>
</tr>
<%if (! "0003".equals(getValue("Order","xml:/Order/@DocumentType"))) {%>
<tr>
<td class="detaillabel" ><yfc:i18n>Open_Authorized</yfc:i18n></td>
<td class="protectednumber"><yfc:getXMLValue binding="xml:/CurrencyList/Currency/@PrefixSymbol"/> <%=getValue("Order","xml:/Order/ChargeTransactionDetails/@TotalOpenAuthorizations")%> <yfc:getXMLValue binding="xml:/CurrencyList/Currency/@PostfixSymbol"/></td>
<td class="detaillabel" ><yfc:i18n>Open_Order_Amount</yfc:i18n></td>
<td class="protectednumber"><yfc:getXMLValue binding="xml:/CurrencyList/Currency/@PrefixSymbol"/> <%=getValue("Order","xml:/Order/ChargeTransactionDetails/@TotalOpenBookings")%> <yfc:getXMLValue binding="xml:/CurrencyList/Currency/@PostfixSymbol"/></td>
</tr>
<%}%>
<tr>
<td class="detaillabel" ><yfc:i18n>Total_Cancelled</yfc:i18n></td>
<td class="protectednumber"><yfc:getXMLValue binding="xml:/CurrencyList/Currency/@PrefixSymbol"/> <%=getValue("Order", "xml:/Order/ChargeTransactionDetails/@TotalCancelled")%>
<yfc:getXMLValue binding="xml:/CurrencyList/Currency/@PostfixSymbol"/></td>
<td>&nbsp;</td>
<td>&nbsp;</td>
</tr>
...
<input type="button" class="button" value="<%=getI18N("Expand_All")%>" <% if(!hasChargesAndAuthorizations){ %> disabled="true" <%}%>  onclick="expandAll('TR','yfsPaymentInfo_','<%=getI18N("Click_To_Hide_Payment_Info")%>','<%=YFSUIBackendConsts.FOLDER_COLLAPSE%>' )" style="cursor:hand" />
<input type="button" class="button" value="<%=getI18N("Collapse_All")%>"   <% if(!hasChargesAndAuthorizations){ %> disabled="true" <%}%> onclick="collapseAll('TR','yfsPaymentInfo_','<%=getI18N("Click_To_See_Payment_Info")%>','<%=YFSUIBackendConsts.FOLDER_EXPAND%>' )" style="cursor:hand"/>
</td>
</tr>
</tbody>
</table>
...
<img id="<%=divToDisplay+"_img"%>" onclick="expandCollapseDetails('<%=divToDisplay%>','<%=getI18N("Click_To_See_Payment_Info")%>','<%=getI18N("Click_To_Hide_Payment_Info")%>','<%=YFSUIBackendConsts.FOLDER_COLLAPSE%>','<%=YFSUIBackendConsts.FOLDER_EXPAND%>')" style="cursor:hand" <%=getImageOptions(YFSUIBackendConsts.FOLDER,"Click_To_See_Payment_Info")%> />
<% bWriteDivTag = true; %>
<%}%>&nbsp;
</td>
<% if(!isSummaryScreen(viewType)){%>
