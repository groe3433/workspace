...
<!-- End CR844 11302012 -->
								...
								<!--<IMG class=lookupicon onclick="callLookup(this,'location','<%=resolveValue("xml:CurrentUser:/User/@Node")%>')" alt="Search for Location" src="/yantra/console/icons/lookup.gif"> !-->
								</TD> 
								</tr>
								<TR>
