...
chargeAmount=getLocalizedStringFromDouble(getLocale(),0.00);
}%>
</yfc:loopXML>
...
<%} else {%>
<yfc:getXMLValue binding="xml:/CurrencyList/Currency/@PrefixSymbol"/>&nbsp;<%=chargeAmount%>&nbsp;<yfc:getXMLValue binding="xml:/CurrencyList/Currency/@PostfixSymbol"/>
<%}%>
</td>
