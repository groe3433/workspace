...
<%
	...
	//System.out.println("mwoKey = " + mwoKey);
	//System.out.println("mwoLineKey = " + mwoLineKey);
	//System.out.println("actualQty = " + actualQty);
	//System.out.println("refurbQty = " + refurbQty);
	//System.out.println("transferQty = " + transferQty);
	...
	//System.out.println("dActualQty = " + dActualQty);
	//System.out.println("dRefurbQty = " + dRefurbQty);
	//System.out.println("dTransferQty = " + dTransferQty);
