...
function disableButton(){
	window.document.getElementById("CreateCountRequestButton").value = "The Count Request is being processed..., Check Count Console !!!";
	window.document.getElementById("CreateCountRequestButton").disabled = true;
}

function enableButton(){
	window.document.getElementById("CreateCountRequestButton").disabled = false;
}

</script>
<script language="javascript">
	window.attachEvent("onload", setCorrectStyle);
	window.attachEvent("onload", checkIfAlreadyProcessing);
	...
	function checkIfAlreadyProcessing(){
		if(document.all("xml:/AgentCriteria/@IsClicked").value == "Y"){
			disableButton();
		}
	}
...
<tr>
	<td colspan="8" align="center">
		<input class="button" type="button" value="<%=getI18N("Create_Count_Request")%>" onclick="sendMessageToJMS();" id="CreateCountRequestButton" />
	</td>
</tr>
