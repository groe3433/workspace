...
%>
		...
		<input type="hidden" name="p_CACHE_ID" value="<%=curUsr.getAttribute("Node")%>" />
...
<%
						String reportDisplayNameArr[] = new String[] {
								...
								"DLA PURCHASE ORDER REPORT","DOCUMENT FACE SHEET REPORT","DRAFT ISSUE REPORT","EXTERNAL AFFAIRS REPORT","GSA PURCHASE ORDER REPORT",
								"INCIDENT OTHER ORDER REPORT","INCIDENT OTHER ORDER SUMMARY REPORT","INCIDENT OTHER ORDER SUMMARY REPORT (WITH KIT SUMMARY)",
								"INCIDENT SUMMARY AND LOSS USE REPORT",
								"INVENTORY BY ZONE REPORT","ITEM EXPIRATION REPORT","ITEM BY SUPPLIER REPORT","ITEM PURCHASE HISTORICAL REPORT",
								"KIT CONTENTS REPORT","KIT PACKING REPORT","KIT RETURN WORKSHEET REPORT","KIT SUMMARY REPORT",
								"LOCAL MANAGED ITEM LIST","LOSS USE REPORT","LOSS USE REPORT (WITH KIT SUMMARY)",
								...
								"PRE DOCUMENT FACE SHEET REPORT (OTHER ACCT CODE)","RECEIPT DETAIL REPORT","REDISTRIBUTION REPORT",
								"RESERVED ITEMS REPORT","RETURN REPORT","RETURN REPORT (BY RETURN NO)",
								"RETURN WORKSHEET BY REFURB TYPE REPORT","RETURN WORKSHEET REPORT","RETURN WORKSHEET REPORT (BLANK)",
								"RETURN WORKSHEET REPORT (BLANK WITH INCIDENT DETAILS)","STOCK STATUS REPORT", "STOCK STATUS BY ITEM REPORT",
								"SUPPLIER REPORT", "SUPPLIER BY ITEM REPORT","TRACKABLE ID TRANSACTION REPORT",
								...
								"TRACKABLE KIT PACKING REPORT", "WORKORDER CONSUMABLE REPORT"};
						String reportNameArr[] = new String[] {
								...
								"BILLED TRANSACTION LISTING REPORT (FS ACCT CODE)","BILLED TRANSACTION LISTING REPORT (OTHER ACCT CODE)",
								"CACHE ITEM TRANSACTION REPORT","CACHE ITEM TRANSACTION REPORT (POST INVENTORY)","CACHE ITEM IN KIT REPORT",
								"CACHE TRANSFER SUMMARY REPORT","CATALOG INFO REPORT","CUSTOMER REPORT",
								"DEDICATED LOCATION VIOLATIONS REPORT","DLA PURCHASE ORDER REPORT","DOCUMENT FACE SHEET REPORT","DRAFT ISSUE REPORT",
								"EXTERNAL AFFAIRS REPORT","GSA PURCHASE ORDER REPORT","INCIDENT OTHER ORDER REPORT",
								"INCIDENT OTHER ORDER SUMMARY REPORT","INCIDENT OTHER ORDER SUMMARY REPORT (WITH KIT SUMMARY)",
								"INCIDENT SUMMARY AND LOSS USE REPORT",
								"INVENTORY BY ZONE REPORT","ITEM EXPIRATION REPORT","ITEM BY SUPPLIER REPORT",
								"ITEM PURCHASE HISTORICAL REPORT","KIT CONTENTS REPORT","KIT PACKING REPORT",
								"KIT RETURN WORKSHEET REPORT","KIT SUMMARY REPORT","LOCAL MANAGED ITEM LIST","LOSS USE REPORT",
								"LOSS USE REPORT (WITH KIT SUMMARY)","NON-TRACKABLE INVENTORY ADJUSTMENT REPORT",
								"OPEN WORKORDER REPORT","OPEN WORKORDER REPORT (BY INCIDENT/OTHER ORDER NO)",
								"OPEN WORKORDER WORKSHEET REPORT","OPEN PO/REQUISITION BY ITEM REPORT",
								"OPEN PO/REQUISITION BY ORDER REPORT","OUTSTANDING SURPLUS REPORT","PHYSICAL COUNT LOCATIONS NOT COUNTED REPORT",
								"PHYSICAL COUNT PREP REPORT","PHYSICAL COUNT RESULTS REPORT","PHYSICAL COUNT RESULTS BY ITEM REPORT",
								"PHYSICAL COUNT STATUS REPORT","PMS SUMMARY REPORT","PMS DOCUMENT FACE SHEET REPORT",
								"PRE DOCUMENT FACE SHEET REPORT (ALL ACCT CODES)","PRE DOCUMENT FACE SHEET REPORT (BLM ACCT CODE)",
								"PRE DOCUMENT FACE SHEET REPORT (FS ACCT CODE)","PRE DOCUMENT FACE SHEET REPORT (OTHER ACCT CODE)",
								"RECEIPT DETAIL REPORT","REDISTRIBUTION REPORT","RESERVED ITEMS REPORT","RETURN REPORT",
								"RETURN REPORT (BY RETURN NO)","RETURN WORKSHEET BY REFURB TYPE REPORT","RETURN WORKSHEET REPORT",
								"RETURN WORKSHEET REPORT (BLANK)","RETURN WORKSHEET REPORT (BLANK WITH INCIDENT DETAILS)",
								"STOCK STATUS REPORT", "STOCK STATUS BY ITEM REPORT","SUPPLIER REPORT", "SUPPLIER BY ITEM REPORT",
								"TRACKABLE ID TRANSACTION REPORT","TRACKABLE INVENTORY ADJUSTMENT REPORT","TRACKABLE INVENTORY REPORT",
								"TRACKABLE INVENTORY STATUS REPORT","TRACKABLE ITEM LOCATION REPORT","TRACKABLE KIT PACKING REPORT", "WORKORDER CONSUMABLE REPORT"};
...
%>
						<tr>
							<td>
								<input readonly=true class=protectedinput size=65 maxLength=90 value="<%=reportDisplayName%>"></td>
							<td>
								<input type="image" SRC='../console/icons/go.gif' NAME=<%=reportName%> onClick='runReport("<%=reportName%>");this.form.target="YantraReports";this.form.action="<%=wmsAnalyticsURL%>";'>
							</td>
						</tr>
<%
						}
