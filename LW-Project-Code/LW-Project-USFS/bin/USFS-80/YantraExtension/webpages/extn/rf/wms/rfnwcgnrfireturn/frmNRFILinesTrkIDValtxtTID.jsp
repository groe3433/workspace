...
<%
	System.out.println("@@@@@ /webpages/extn/rf/wms/rfnwcgrfireturns/frmNRFILinesTrkIDValtxtTID.jsp");
...
<%
			...
			YFCDocument doc=getForm("/frmNRFILinesTrkID");
			String strValue = "0";
			...
			String formName = "/frmNRFILinesTrkID" ;	
