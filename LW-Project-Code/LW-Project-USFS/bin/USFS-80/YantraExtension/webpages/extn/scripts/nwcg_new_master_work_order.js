...
//				alert(elemAttr.nodeValue);
	...
	if(strTimeSensitive == "Y")
	{
		...
		// append the string with attribute name and the corresponding value
		x.innerHTML = x.innerHTML + '<br> Ship By Date <br><input class="dateinput" type="text" name="xml:/WorkOrder/WorkOrderComponents/WorkOrderComponent_'+rIndex+'/@ShipByDate"><IMG class=lookupicon onclick="invokeCalendar(this);return false" alt=Calendar src="/yantra/console/icons/calendar.gif" name=search/>';
	}
}
...
//				alert(elemAttr.nodeValue);
	...
	if(strTimeSensitive == "Y")
	{
		...
		// append the string with attribute name and the corresponding value
		x.innerHTML = x.innerHTML + '<br> Ship By Date <br><input class="dateinput" type="text" name="xml:/WorkOrder/WorkOrderComponents/WorkOrderComponent_'+strId+'/@ShipByDate"><IMG class=lookupicon onclick="invokeCalendar(this);return false" alt=Calendar src="/yantra/console/icons/calendar.gif" name=search/>';
	}
}
