...
String notesElemPath = saveBinding + "/"+ notesListElemName + "/" + notesElemName +"/";
String notesListLoopRootElem = getBinding+"/"+ notesListElemName+"/@"+notesElemName;
String notesListLoopElem = "xml:/"+notesElemName+"/";
%>

<script language=jscript src="/yantra/console/scripts/om.js">
</script>
...
<tr>
<td>
<input type="hidden" name="allowedBinding" value='<%=allowedBinding%>' />
<input type="hidden" name="getBinding" value='<%=getBinding%>' />
<input type="hidden" name="saveBinding" value='<%=saveBinding%>' />
<input type="hidden" name="isWorkOrderNotesPopup" value='<%=isWorkOrderNotesPopup%>' />
</td>
</tr>
</thead>
<tbody>
