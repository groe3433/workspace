...
%>
    <input type="hidden" yName="xml:/AddressTemp/@AllowedModValue" value="<%=allowedModValue%>"/>
    ...
    <input type="hidden" yName="<%=outputPath%>@UseCount" class="protectedtext" contentEditable=false value="<%=usecount%>">
    <input type="hidden" yName="<%=outputPath%>@VerificationStatus" class="protectedtext" contentEditable=false value="<%=verificationstatus%>">
    <input type="hidden"  Name="tempAddrLine1" class="protectedtext" contentEditable=false value="<%=addressLine1%>">
    <input type="hidden"  Name="tempState" class="protectedtext" contentEditable=false value="<%=state%>">
