...
%>
	...
	<Input type="hidden" name="xml:/WorkOrder/@ServiceItemGroupCode" value="KIT")"/>
...
<!--				<input class="unprotectedinput" type="text" <%=getTextOptions("xml:/WorkOrder/@ServiceItemID")%>/>-->
			<input class="unprotectedinput" type="text" name="xml:/WorkOrder/@ServiceItemID" value="REFURBISHMENT"/>
				...
				<!--Commented out by Ram 07/03/2006-->
			<!--	<img class="lookupicon" name="search" onclick="callServiceItemLookup('xml:/WorkOrder/@ServiceItemID','xml:/WorkOrder/@ProductClass','xml:/WorkOrder/@Uom', 'item','<%=resolveValue("xml:/WorkOrder/@ServiceItemGroupCode")%>','<%=extraParams%>')" <%=getImageOptions(YFSUIBackendConsts.LOOKUP_ICON, "Search_for_Service_Item")%> /> -->
					<img class="lookupicon" name="search" onclick="callServiceItemLookup('xml:/WorkOrder/@ServiceItemID','xml:/WorkOrder/@ProductClass','xml:/WorkOrder/@Uom', 'item','KIT','<%=extraParams%>')" <%=getImageOptions(YFSUIBackendConsts.LOOKUP_ICON, "Search_for_Service_Item")%> />
			</td>

			<td class="detaillabel"><yfc:i18n>Incident_Number</yfc:i18n></td>
			<td nowrap="true">
			<input type="text" class="unprotectedinput" name="xml:/WorkOrder/Extn/@ExtnIncidentNo"  id="xml:/WorkOrder/Extn/@ExtnIncidentNo" onblur="javascript:fetchDataFromServer(this,'getWorkOrderCodes',updateIncidentDetailsForWO);"/>
				<!--<input type="text" size= "23" class="unprotectedinput" <%=getTextOptions("xml:/WorkOrder/Extn/@ExtnIncidentNo")%>/>-->
