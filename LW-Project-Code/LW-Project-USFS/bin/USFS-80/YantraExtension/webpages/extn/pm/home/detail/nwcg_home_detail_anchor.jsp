...
<script language="javascript" src="/yantra/console/scripts/pm.js">
...
<tr>
    <td width="20%" align="left" class="searchlabel" >&nbsp;
		...
		<%=getFormatedI18N("Welcome_User_Message", getValue((YFCElement)session.getAttribute("CurrentUser"),"xml:/User/@Username"))%>
