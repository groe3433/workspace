...
if(equals("Y",getValue("ItemDetails","xml:/Item/PrimaryInformation/@SerializedFlag"))){%>
...
<% //prompt for serial no if serialized
if(equals(resolveValue("xml:ItemDetails:/Item/PrimaryInformation/@SerializedFlag"),"Y")) { %>
<td>
