...
<img class="lookupicon" <%=getImageOptions("/yantra/console/icons/gift.gif", "Return_By_Gift_Recipient")%>/>
<%	}	%>
</td>
...
<% if (modify) {%>
<td nowrap="true">
<input class="dateinput" type="text" <%if (equals(sRequestDOM,"Y")) {%> OldValue="<%=resolveValue("xml:OrigAPIOutput:/Order/@OrderDate")%>"  <%}%>  <%=getTextOptions("xml:/Order/@OrderDate")%>/>
