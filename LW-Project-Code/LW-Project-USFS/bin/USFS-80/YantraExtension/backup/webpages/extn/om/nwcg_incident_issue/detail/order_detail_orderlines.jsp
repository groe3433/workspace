...
<td class="tablecolumnheader" nowrap="true" sortable="no" style="width:<%=getUITableSize("xml:/OrderLine/Extn/@ExtnRequestNo")%>"><yfc:i18n>Request_Number</yfc:i18n></td>
...
<!--<td class="tablecolumnheader" nowrap="true" sortable="no" style="width:<%=getUITableSize("xml:/OrderLine/@ReceivingNode")%>"><yfc:i18n>Recv_Node</yfc:i18n></td>
...
<img <%=getImageOptions("/yantra/console/icons/gift.gif", "This_is_a_Gift_Line")%>/>
<% } %>
...
<a <%=getDetailHrefOptions("L12", getParameter("orderLineKey"), "")%>><img class="columnicon" <%=getImageOptions("/yantra/console/icons/providedservicecol.gif", "Line_Has_Associated_Service_Requests")%> ></a>

<%	}	else	if (equals(getValue("OrderLine","xml:/OrderLine/@CanAddServiceLines"),"Y") && ! equals(getValue("Order","xml:/Order/@isHistory"),"Y")) { %>
<a <%=getDetailHrefOptions("L10", getParameter("orderLineKey"), "")%>><img class="columnicon" <%=getImageOptions("/yantra/console/icons/addprovidedservice.gif", "Line_Has_Service_Requests_That_Can_Be_Added")%> ></a>
<%	}	%>
<%}%>
...
<img class="columnicon" <%=getImageOptions("/yantra/console/icons/deliveryitem.gif", "Delivery_Request_needs_to_be_added")%>></a>
<%	}
...
if (!isVoid(linkForWorkOrder)) {
%>
<a <%=getDetailHrefOptions(linkForWorkOrder, getParameter(keyNameForLink), "")%>>
<img class="columnicon" <%=getImageOptions("/yantra/console/icons/workorders.gif", "View_Work_Orders")%>>
</a>
<%  } %>
</td>
<!--Commented out on 08/18/2005 by Ram-->
...
<td class="tablecolumn" nowrap="true">
<input type="text"   <%if(bAppendOldValue) { %>OldValue="<%=resolveValue("xml:OrigAPIOrderLine:/OrderLine/Extn/@ExtnRequestNo")%>"  <%}%> <%=yfsGetTextOptions("xml:/Order/OrderLines/OrderLine_" + OrderLineCounter + "/Extn/@ExtnRequestNo", "xml:/OrderLine/Extn/@ExtnRequestNo", "xml:/OrderLine/AllowedModifications")%>/>
</td>
...
<!--<td class="tablecolumn" nowrap="true">
<input type="text"  <%if(bAppendOldValue) { %>OldValue="<%=resolveValue("xml:OrigAPIOrderLine:/OrderLine/@ReceivingNode")%>"  <%}%> <%=yfsGetTextOptions("xml:/Order/OrderLines/OrderLine_" + OrderLineCounter + "/@ReceivingNode", "xml:/OrderLine/@ReceivingNode", "xml:/OrderLine/AllowedModifications")%>/>
...
<!--<td class="tablecolumn">&nbsp;</td>--> <!--Commented out on 08/18/2005 by Ram-->
<td class="tablecolumn" nowrap="true">
