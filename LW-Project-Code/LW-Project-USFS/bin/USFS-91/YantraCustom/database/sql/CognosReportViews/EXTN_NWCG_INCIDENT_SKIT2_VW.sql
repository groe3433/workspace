CREATE OR REPLACE FORCE VIEW EXTN_NWCG_INCIDENT_SKIT2_VW ("SUPER_SUPER_PARENT", "SUPER_SUPER_PARENT_DESC", "SUPER_SUPER_PARENT_QTY_ISSUED", "TRANSFER_IN", "TRANSFER_OUT", "SUPER_PARENT", "SUPER_PARENT_DESC", "SUPER_PARENT_KIT_QTY", "PARENT_ITEM", "PARENT_DESC", "PARENT_KIT_QTY", "COMP_ITEM", "ITEM_DESCRIPTION", "COMP_KIT_QTY", "CLASS", "UOM", "INCIDENT NO", "EXTN_INCIDENT_NAME", "OTHER ACCT CODE", "BLM ACCT CODE", "FS ACCT CODE", "EXTN_OVERRIDE_CODE", "YEAR", "CACHE ID")
AS
  SELECT k2_vw.super_super_parent,
    (SELECT description FROM yfs_item WHERE item_id = k2_vw.super_super_parent
    ) "SUPER_SUPER_PARENT_DESC",
    ...
    AND ol.item_id            = k2_vw.super_super_parent
    ) "SUPER_SUPER_PARENT_QTY_ISSUED",
    ...
    m.year,
    k2_vw."CACHE ID"
  FROM extn_nwcg_incident_rpt_kit3_vw k2_vw,
