...
%>
<script language="javascript" src="<%=request.getContextPath()%>/console/scripts/menubar.js" ></script>
<script language="javascript" src="<%=request.getContextPath()%>/yfcscripts/popup.js" ></script>
...
<div class="menumainbar">
	...
	<table cellpadding=0 cellspacing=0 border=0 class="menubox1box1">
		<tr class="menutoppart">
			...
			<td class="menutopusername">
				<%=getValue((YFCElement)session.getAttribute("CurrentUser"),"xml:/User/@Username")%>
			</td>
														...
														<yfc:loopXML binding="xml:mymenu:/Menu/SubMenu/@Menu" id="submenu" keyName='MenuKey' >
                                                             ...
                                                             <% String linkparam = "window.parent.location.href='";
                                                                ...
                                                                if (("ENTITY".equals(resourceType)) && (!"system".equals(resourceID))) {
																	linkparam += request.getContextPath()+"/console/" + getValue(submenu,"xml:/Menu/Resource/@ResourceId") + ".search";
																	...
																	linkparam += request.getContextPath()+"/console/" + entityID + ".detail?CurrentDetailViewID=" + viewID ;
																}
																else{
