...
<%
	...
	String orgCode = getValue("CurrentOrganization", getSelectedOrgCodeValue("xml:/Item/@CallingOrganizationCode"));
	
	if(orgCode != null && orgCode.equals("DEFAULT") || orgCode.equals(""))
		orgCode = "NWCG";
%>
<tr>
...
<tr>
    <td nowrap="true" class="searchcriteriacell" >
		<input type="text" class="protectedinput" contenteditable="false" <%=getTextOptions("xml:/Item/@CallingOrganizationCode",orgCode,orgCode)%>/>
    </td>
</tr>
...
onclick="callItemLookup('xml:/NWCGSupplierItem/@ItemID','xml:/Item/@ProductClass','xml:/NWCGSupplierItem/@UnitOfMeasure',
...
<tr>
    <td class="searchlabel" ><yfc:i18n>Supplier_Standard_Pack</yfc:i18n></td>
</tr>
<tr>
    <td nowrap="true" class="searchcriteriacell" >
