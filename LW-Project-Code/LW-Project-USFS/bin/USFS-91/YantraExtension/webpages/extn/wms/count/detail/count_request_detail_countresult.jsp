...
function enterActionVarianceRSN(modReasonViewID, modReasonCodeBinding, modReasonTextBinding) {
    var myObject = new Object();
    var countEnterpriseKey = "<CountRequest EnterpriseCode=\""+document.all("xml:/CountRequest/@EnterpriseCode").value+"\" RequestType=\""+document.all("xml:/CountRequest/@RequestType").value+"\"/>";
    ...
    yfcShowDetailPopup(modReasonViewID, "", "550", "255", myObject, "adjustreasoncode", countEnterpriseKey);
...
<table width="100%" class="view">
	<tr>
		...
		<td class="protectedtext" nowrap="true">
			...
			<%	if (getNumericValue("xml:/CountResultList/@NoOfVarianceResults") <= 								Double.parseDouble(getDefaultMaxRecords()) && getNumericValue("xml:/CountResultList/@NoOfVarianceResults") > 0) { %>
				<a href="javascript:showDetailForViewGroupId('count', 'NWCYWMD083','<%=getParameter("CountResultKey")%>')">
	...
	<input type="hidden" name="xml:/CountRequest/@RequestType" value="<%=resolveValue("xml:/CountRequest/@RequestType")%>"/>
</table>
