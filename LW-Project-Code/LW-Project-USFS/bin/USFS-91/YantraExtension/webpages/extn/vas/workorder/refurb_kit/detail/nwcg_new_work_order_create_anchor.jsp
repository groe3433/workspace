...
<script language="javascript">
	function moveToNextPage()
	{
		...
		var ServiceItemGroupCode = document.createElement("<INPUT type='hidden' name='xml:/WorkOrder/@ServiceItemGroupCode' value='KIT'/>");
		...
		showDetailForOnAdvancedList('workorder', 'NWRYVSD011', sVal.value, extraParams); 
	}
...
//		var ServiceItemGroupCode=document.all("xml:/WorkOrder/@ServiceItemGroupCode").value;
	...
	function doNormalWindow()
	{
		...
		{
			oError.value="Y";
			yfcChangeDetailView('NWRYVSD011');
		}
	}
