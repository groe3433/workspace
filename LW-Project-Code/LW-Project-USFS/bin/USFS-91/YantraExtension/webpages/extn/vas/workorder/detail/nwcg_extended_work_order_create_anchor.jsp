...
<script language="javascript">
	function moveToNextPage()
	{
		...
		showDetailForOnAdvancedList('workorder', 'NWGYVSD011', sVal.value, extraParams); 
	}
	...
	function doNormalWindow()
	{
		...
		{
			oError.value="Y";
			yfcChangeDetailView('NWGYVSD011');
		}
	}
</script>
...
<table cellSpacing=0 class="anchor" cellpadding="7px">
	...
	<tr>
		<td align="center">
			<input class="button" type="button" value="<%=getI18N("Proceed")%>" onclick="javascript:if(document.getElementById('xml:/WorkOrder/@QuantityRequested').value == '' || document.getElementById('xml:/WorkOrder/@QuantityRequested').value == 0){alert('Please enter \'Requested Qty\' for this Work Order');return false};proceedToChange(this);" />
