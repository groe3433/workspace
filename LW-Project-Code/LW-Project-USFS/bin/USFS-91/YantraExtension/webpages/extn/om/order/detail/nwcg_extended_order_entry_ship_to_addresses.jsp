...
<tr>
	...
	<td>
		<select class="combobox" <%=getComboOptions(Path+"/@State")%>>
			...
			selected='<%=resolveValue(Path+"/@State")%>'/>
		</select>
	</td>
</tr>
<tr>
...
<td><input type="text" class="unprotectedinput" maxLength='30' size='30'  <%=getTextOptions(Path+"/@AlternateEmailID")%> id="xml:/Order/PersonInfoShipTo/@AlternateEmailID"></td>
</tr>
