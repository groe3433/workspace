...
<%
	...
	//Prepare the input for getCommonCodeList to get NWCG_LINE_VIEW - Make "Get Avail RFI" for each line input element for API call
...
<table class="sortableTable" ID="OrderLines" cellspacing="0" width="100%" yfcMaxSortingRecords="1000">
	<thead>
		<tr>
			...
			<td class="tablecolumnheader" nowrap="true" style="width:5px; font-size:12px">Line</td>
			<td class="tablecolumnheader" nowrap="false" style="width:10px; font-size:12px"><yfc:i18n>S_#</yfc:i18n></td>
			<td class="tablecolumnheader" nowrap="true" style="width:40px; font-size:12px"><yfc:i18n>Item_ID</yfc:i18n></td>
			<td class="tablecolumnheader" style="width:40px; font-size:12px" sortable="no"><yfc:i18n>PC</yfc:i18n></td>
			<td class="tablecolumnheader" style="width:10px; font-size:12px" sortable="no"><yfc:i18n>UOM</yfc:i18n></td>
			<td class="tablecolumnheader" style="width:110px; font-size:12px" sortable="no"><yfc:i18n>Description</yfc:i18n></td>
<%
			if (displaySysNoCol) { 
%>
				<td class="tablecolumnheader" style="width:10px; font-size:12px" sortable="no"><yfc:i18n>System_Number</yfc:i18n></td>
<% 
			} 
%>
			<td class="tablecolumnheader" nowrap="true" sortable="no" style="width:40px; font-size:12px"><yfc:i18n>Requested_Qty</yfc:i18n></td>
			<td class="tablecolumnheader" nowrap="false" sortable="no" style="width:40px; font-size:12px"><yfc:i18n>Avail_RFI_Qty</yfc:i18n></td>
			<td class="tablecolumnheader" nowrap="false" sortable="no" style="width:<%=getUITableSize("xml:/OrderLine/Extn/@ExtnFwdQty")%>; font-size:12px"><yfc:i18n>Issue_Qty</yfc:i18n></td>
			<td class="tablecolumnheader" nowrap="true" sortable="no" style="width:30px; font-size:12px"><yfc:i18n>Actual Pricing Qty</yfc:i18n></td>
			<td class="tablecolumnheader" nowrap="false" sortable="no" style="width:<%=getUITableSize("xml:/OrderLine/Extn/@ExtnUTFQty")%>; font-size:12px"><yfc:i18n>UTF_Qty</yfc:i18n></td>
			<td class="tablecolumnheader" nowrap="true" sortable="no" style="width:<%=getUITableSize("xml:/OrderLine/Extn/@ExtnBackorderedQty")%>; font-size:12px"><yfc:i18n>Backordered_Qty</yfc:i18n></td>
			<td class="tablecolumnheader" nowrap="true" sortable="no" style="width:<%=getUITableSize("xml:/OrderLine/Extn/@ExtnFwdQty")%>; font-size:12px"><yfc:i18n>Forwarded_Qty</yfc:i18n></td>
<% 
			if (equals(driverDate, "02")) { 
%>
				<td class="tablecolumnheader" nowrap="true" sortable="no" style="width:80px; font-size:12px"><yfc:i18n>Delivery_Date</yfc:i18n></td>
<% 
			} else { 
%>
				<td class="tablecolumnheader" nowrap="true" sortable="no" style="width:80px; font-size:12px"><yfc:i18n>Ship_Date</yfc:i18n></td>
<% 
			} 
%>
			<td class="tablecolumnheader" nowrap="true" sortable="no" style="width:100px; font-size:12px"><yfc:i18n>Comments</yfc:i18n></td>
			<td class="tablecolumnheader" style="width:50px; font-size:12px"  sortable="no"><yfc:i18n>Amount</yfc:i18n></td>
			<td class="tablecolumnheader" style="width:<%=getUITableSize("xml:/OrderLine/@Status")%>; font-size:12px"  sortable="no"><yfc:i18n>Status</yfc:i18n></td>
		</tr>
	</thead>
	<tbody>
