...
<yfc:getXMLValue binding="xml:ReceivingDiscrepancy:/ReceivingDiscrepancy/Shipment/@ShipmentNo"/>
</td>
<td class="tablecolumn" >
...
<% String discCodeTargetBinding = "xml:/ReceivingDiscrepancies/ReceivingDiscrepancy_" + ReceivingDiscrepancyCounter + "/ReceivingDiscrepancyDtls/ReceivingDiscrepancyDtl_" + ReceivingDiscrepancyDtlCounter + "/@DiscrReasonCode"; %>
<select class="combobox" NewResetValue="true" NewName="true" <%=getComboOptions(discCodeTargetBinding, "xml:ReceivingDiscrepancyDtl:/ReceivingDiscrepancyDtl/@DiscrReasonCode")%> <%=sDisable%>>
<yfc:loopOptions binding="xml:ReceivingDiscrReasonList:/ReceivingDiscrReasonList/@ReceivingDiscrReason"
value="DiscrReasonCode" name="DiscrReasonDescription" selected="xml:ReceivingDiscrepancyDtl:/ReceivingDiscrepancyDtl/@DiscrReasonCode" targetBinding="<%=discCodeTargetBinding%>"/>
</select>
