...
%>
	...
	<tr>
		...
		<td>
			...
			<input type="text" style="height:24px; font-size:18px" class="unprotectedinput" onChange="setRequestDeliverDate(this);setExtnReqDelDateInDiffPanels(this, 'xml:/Order/Extn/@TestExtnReqDeliveryDate_YFCDATE')" <%=getTextOptions("xml:/Order/Extn/@ExtnReqDeliveryDate_YFCDATE")%>/>
			...
			<input type="text" style="height:24px; font-size:18px" class="unprotectedinput"  onChange="setExtnReqDelDateInDiffPanels(this, 'xml:/Order/Extn/@TestExtnReqDeliveryDate_YFCTIME')" <%=getTextOptions("xml:/Order/Extn/@ExtnReqDeliveryDate_YFCTIME")%>/>
