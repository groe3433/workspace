...
public class FanAddressValidationResponse {
	
	private static YFCLogCategory logger = YFCLogCategory.instance("com.yantra.yfc.log.YFCLogCategory");

	public Document performValidation (Document inDoc) throws ParserConfigurationException, SAXException, IOException{
