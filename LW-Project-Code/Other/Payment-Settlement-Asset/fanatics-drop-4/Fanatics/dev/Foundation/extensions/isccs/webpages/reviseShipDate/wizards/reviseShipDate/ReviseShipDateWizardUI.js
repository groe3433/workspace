...
templateText, _dijitButton, _dojodeclare, _dojokernel, _dojolang, _dojotext, _idxContentPane, _isccsBaseTemplateUtils, _isccsContextUtils, _isccsMobileUtils, _isccsOrderUtils, _isccsUIUtils, _isccsWidgetUtils, _isccsWizardUtils, _scplat, _scButtonDataBinder, _scBaseUtils, _scControllerUtils, _scEventUtils, _scModelUtils, _scScreenUtils, _scWizardUtils, _scWizard) {
    return _dojodeclare("extn.reviseShipDate.wizards.reviseShipDate.ReviseShipDateWizardUI", [_scWizard], {
        templateString: templateText,
        uId: "ReviseShipDateWizard",
        packageName: "extn.reviseShipDate.wizards.reviseShipDate",
        className: "ReviseShipDateWizard",
        title: "Revise Ship Date",
        ...
        event, bEvent, ctrl, args) {
            ...
            this, "extn_reviseShipDate_tile", subTitle);
        },
