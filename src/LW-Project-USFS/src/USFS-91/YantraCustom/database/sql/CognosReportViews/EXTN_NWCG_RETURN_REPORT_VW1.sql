CREATE OR REPLACE FORCE VIEW EXTN_NWCG_RETURN_REPORT_VW1 ("RECEIPT NO", "ITEM_ID", "ITEM_DESCRIPTION", "UOM", "SERIAL_NO", "QUANTITY_RETURNED", "QUANTITY_RFI", "QUANTITY_NRFI", "QUANTITY_UNSERVICED", "QUANTITY_UNSERVICED_NWT", "QUANTITY_WORDERED", "QUANTITY_REFURBED", "QUANTITY_REFURBED_UNS", "QUANTITY_REFURBED_UNS_NWT", "REFURB_COST", "INCIDENT NO", "INCIDENT_NAME", "RETURN_DATE", "EXTN_RETURN_COMMENTS", "INSPECTION_COMMENTS", "INCIDENT_OTHER_ACCT_CODE", "INCIDENT_BLM_ACCT_CODE", "INCIDENT_FS_ACCT_CODE", "OVERRIDE_CODE", "UNIT_PRICE", "YEAR", "CACHE ID", "COMPANY", "RETURN_TO_ADDRESS1", "RETURN_TO_ADDRESS2", "RETURN_TO_CITY", "RETURN_TO_STATE", "RETURN_TO_ZIP", "SHIP_TO_COMPANY", "SHIP_TO_ADDRESS1", "SHIP_TO_ADDRESS2", "SHIP_TO_CITY", "SHIP_TO_STATE", "SHIP_TO_ZIP")
AS
