...
public class NWCGAppendMissingStatus implements YIFCustomApi {
	...
	public Document appendMissingStatus(YFSEnvironment env, Document inXML)
			throws Exception {
		Document docOut = CommonUtilities.invokeAPI(env,
				getCommonCodeTemplate(), "getCommonCodeList", inXML);
