...
<thead>
    <tr> 
        ...
        <td class="tablecolumnheader" style="">
            <yfc:i18n>Batch_Number</yfc:i18n>
        </td>
        <td class="tablecolumnheader" style="">
            <yfc:i18n>WorkOrder_Number</yfc:i18n>
        </td>
         <td class="tablecolumnheader" style="">
...
<%   if (bylpn) {
		if((!(isVoid(resolveValue("xml:LocationInventoryAudit:/LocationInventoryAudit/InventoryItem/@ItemID")))) && (!(isVoid(resolveValue("xml:LocationInventoryAudit:/LocationInventoryAudit/@PalletId"))) || !(isVoid(resolveValue("xml:LocationInventoryAudit:/LocationInventoryAudit/@CaseId"))))){  %>
			<tr> 
				...
				<td class="tablecolumn">
				<%if(getNumericValue("xml:LocationInventoryAudit:/LocationInventoryAudit/@ReleaseNo") != 0){%>
				...
				<td class="tablecolumn">
					<yfc:getXMLValue name="LocationInventoryAudit" binding="xml:LocationInventoryAudit:/LocationInventoryAudit/@BatchNo"/>
				</td>
				<td class="tablecolumn">
					<yfc:getXMLValue name="LocationInventoryAudit" binding="xml:LocationInventoryAudit:/LocationInventoryAudit/WorkOrder/@WorkOrderNo"/>
				</td>
				<td class="tablecolumn">
