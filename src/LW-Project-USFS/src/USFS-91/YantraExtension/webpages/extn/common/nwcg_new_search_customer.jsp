...
<img class="lookupicon" onclick="callLookup(this,'<%=sLookup%>');" id="LoadImage" <%=getImageOptions(YFSUIBackendConsts.LOOKUP_ICON, "Search_for_Customer") %> />
</td>
<td/><input type=button value="Load" id="LoadButton" onclick="fetchDataFromServer(document.getElementById('xml:/Customer/@CustomerID'),'getCustomerList',displayCustomerList)"/>
</tr>
</table>