		...
		<td class="tablecolumn">
			<yfc:getXMLValue name="ReceiptLine" binding="xml:/ReceiptLine/@ItemID"/>
				...
				<input type="hidden"
				 ...
				 <input type="hidden"
				 <%=getTextOptions("xml:/Receipt/ReceiptLines/ReceiptLine_"+ ReceiptLineCounter+"/@ItemID", "xml:/ReceiptLine/@ItemID")%>/>
				 <input type="hidden"
				 <%=getTextOptions("xml:/Receipt/ReceiptLines/ReceiptLine_"+ ReceiptLineCounter+"/@ProductClass", "xml:/ReceiptLine/@ProductClass")%>/>
				 <input type="hidden"
				 <%=getTextOptions("xml:/Receipt/ReceiptLines/ReceiptLine_"+ ReceiptLineCounter+"/@UnitOfMeasure", "xml:/ReceiptLine/@UnitOfMeasure")%>/>
				  <input type="hidden"
				 <%=getTextOptions("xml:/Receipt/ReceiptLines/ReceiptLine_"+ ReceiptLineCounter+"/OrderLine/@ReceivingNode", "xml:/ReceiptLine/OrderLine/@ReceivingNode")%>/>
	    </td>
		<td class="tablecolumn">
