...
<%
String documentType = getValue("Shipment", "xml:/Shipment/@DocumentType");
...
<% } else { %>
<a <%=getDetailHrefOptions("L02",documentType, getParameter("shipmentKey"),"")%> >
<yfc:getXMLValue name="Shipment" binding="xml:/Shipment/@ShipmentNo"/>
</a>
<% } %>
</td>
...
<%
String documentType2 = getValue("Shipment", "xml:/Shipment/@DocumentType");
if (documentType2.indexOf(".") != -1){
	documentType2 = documentType2.substring(0, documentType2.indexOf("."));
}
%>
...
<yfc:getXMLValue name="Shipment" binding="xml:/Shipment/@ShipmentNo"/>
<% } else { %>
<a <%=getDetailHrefOptions("L02",documentType2,getParameter("shipmentKey"),"")%> >
<yfc:getXMLValue name="Shipment" binding="xml:/Shipment/@ShipmentNo"/>
</a>
<% } %>
</td>
