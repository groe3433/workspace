...
<tr>
    ...
    <td class="detaillabel" ><yfc:i18n>Return_Receipt_#</yfc:i18n></td>
...
<tr>
	...
	<td class="protectedtext">
	<yfc:getXMLValue binding="xml:/Receipt/Shipment/@BillToCustomerId"/>
	</td>
...
<tr>
    ...
    <td class="protectedtext"><%=resolveValue("xml:/Receipt/Extn/@ExtnIncidentNo")%></td>
</tr>
<tr>
    ...
    <td class="protectedtext"><%=resolveValue("xml:/Receipt/Extn/@ExtnIncidentYear")%></td>
</tr>
</table>
