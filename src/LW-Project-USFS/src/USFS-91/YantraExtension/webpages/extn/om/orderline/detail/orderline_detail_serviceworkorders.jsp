...
<tr>
<td>
<input type="button" class="button" value="<%=getI18N("Expand_All")%>" <% if(false){ %> disabled="true" <%}%>  onclick="expandAll('TR','yfsWorkOrderDetails_','<%=getI18N("Click_To_Hide_Payment_Info")%>','<%=YFSUIBackendConsts.FOLDER_COLLAPSE%>' )" style="cursor:hand" />
<input type="button" class="button" value="<%=getI18N("Collapse_All")%>"   <% if(false){ %> disabled="true" <%}%> onclick="collapseAll('TR','yfsWorkOrderDetails_','<%=getI18N("Click_To_See_Payment_Info")%>','<%=YFSUIBackendConsts.FOLDER_EXPAND%>' )" style="cursor:hand"/>
</td>
</tr>
</tbody>
</table>
...
<% } %>
<img id="<%=divToDisplay+"_img"%>" onclick="expandCollapseDetails('<%=divToDisplay%>','<%=getI18N("Click_To_See_Work_Order_Lines")%>','<%=getI18N("Click_To_Hide_Work_Order_Lines")%>','<%=YFSUIBackendConsts.FOLDER_COLLAPSE%>','<%=YFSUIBackendConsts.FOLDER_EXPAND%>')" style="cursor:hand" <%=getImageOptions(YFSUIBackendConsts.FOLDER_COLLAPSE,"Click_To_See_Work_Order_Lines")%> />
</td>
