...
<td class="checkboxcolumn"><input type="checkbox" value='<%=getParameter("orderReleaseKey")%>' name="chkEntityKey"/></td>
...
<%=displayOrderStatus(getValue("OrderRelease","xml:/OrderRelease/@MultipleStatusesExist"),getValue("OrderRelease","xml:/OrderRelease/@MaxOrderReleaseStatusDesc"))%></a>
</td>
</tr>
</yfc:loopXML>
</tbody>
