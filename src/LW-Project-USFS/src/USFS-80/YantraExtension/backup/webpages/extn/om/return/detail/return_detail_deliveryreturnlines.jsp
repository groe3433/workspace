...
<td class="tablecolumn"><%=displayOrderStatus(getValue("OrderLine","xml:/OrderLine/@MultipleStatusesExist"),getValue("OrderLine","xml:/OrderLine/@MaxLineStatusDesc"))%></td>	<!-- cr 40096, replaced with proper i18n for cr 56554 -->
</tr>
<%}%>
</yfc:loopXML>
</tbody>
