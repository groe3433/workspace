...
<tr>
<td class="detaillabel" ><yfc:i18n>Invoiced</yfc:i18n></td>
<td class="protectednumber"><span class="protectednumber" ><%=getValue("Order", "xml:/Order/InvoicedTotals/@GrandTotal")%>&nbsp;</span><span class="protectedtext"  style="width:8px"><yfc:i18n>Minus</yfc:i18n></span></td>
</tr>
<tr>
<td class="detaillabel" ><yfc:i18n>Balance</yfc:i18n></td>
<td class="totaltext"><span class="protectednumber" ><yfc:getXMLValue binding="xml:/CurrencyList/Currency/@PrefixSymbol"/>&nbsp; <%=getValue("Order", "xml:/Order/RemainingTotals/@GrandTotal")%>&nbsp;<yfc:getXMLValue binding="xml:/CurrencyList/Currency/@PostfixSymbol"/></span><span class="protectedtext"  style="width:8px"></span>
</td>
</tr>
</table>
