...
<tr class='<%=className%>'>
<td>
<img onclick="expandCollapseDetails('optionSet_<%=KitLineCounter%>','<%=getI18N("Click_To_Add_Kit_Info")%>','<%=getI18N("Click_To_Hide_Kit_Info")%>','<%=YFSUIBackendConsts.FOLDER_COLLAPSE%>','<%=YFSUIBackendConsts.FOLDER_EXPAND%>')"  style="cursor:hand" <%=getImageOptions(YFSUIBackendConsts.FOLDER,"Click_To_Add_Kit_Info")%> />
