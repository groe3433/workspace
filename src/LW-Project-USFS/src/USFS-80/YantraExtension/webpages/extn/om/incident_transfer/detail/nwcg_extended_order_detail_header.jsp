...
<tr>
        ...
        <td>
            <input type="text" class="unprotectedinput" <%=getTextOptions("xml:/Order/Extn/@ExtnIncidentYear")%> id="xml:/Order/Extn/@ExtnIncidentYear" onblur="javascript:if(document.getElementById('xml:/Order/Extn/@ExtnIncidentYear').value=='' || document.getElementById('xml:/Order/Extn/@ExtnIncidentNo').value=='' )
			{
			alert('Please enter Incident# and Year');
			return false; }
			fetchDataWithParams(document.getElementById('xml:/Order/Extn/@ExtnIncidentNo'),
			'getIncidentDetails',
			updateFromIncidentDetailsWithoutCustDetail,
			setToIncidentTransferParam(this));"/>
        </td>
...
<input type="text" class="unprotectedinput" <%=getTextOptions("xml:/Order/Extn/@ExtnOtherAmount")%>/>
 ...
 <td class="detaillabel" ><yfc:i18n>To_Incident_No</yfc:i18n></td>
   <td>
    ...
    <td>
    <input type="text" class="unprotectedinput"  <%=getTextOptions("xml:/Order/Extn/@ExtnToIncidentYear")%> id="xml:/Order/Extn/@ExtnToIncidentYear" onblur="javascript:if(document.getElementById('xml:/Order/Extn/@ExtnToIncidentYear').value=='' || document.getElementById('xml:/Order/Extn/@ExtnToIncidentNo').value=='' )
	{
	alert('Please enter Incident# and Year');
	return false;
	}
	fetchDataWithParams(document.getElementById('xml:/Order/Extn/@ExtnToIncidentNo'),
	'getIncidentDetails',
	updateToIncidentDetailsWithoutCustDetail,
	setFromIncidentTransferParam(this));"/>
 </td>
