...
<thead>
    <tr> 
        ...
        <td class="tablecolumnheader" sortable="no">
             <yfc:i18n>Modification_Code</yfc:i18n>
        </td>
        <td class="tablecolumnheader" sortable="no">
    ...
    <yfc:loopXML name="AuditList" binding="xml:/AuditList/@Audit" id="ItemAudit" > 
        ...
        <tr>
            ...
            <td class="tablecolumn">
                ...
                <yfc:getXMLValue name="ItemAudit" binding="xml:/Audit/@Reference1"/>
            </td>
            <td class="tablecolumn">
        ...
        <tr id="<%=divToDisplay%>" style="display:none" BypassRowColoring="true">
            <td class="tablecolumn" colspan="6">
                ...
                %>
                <jsp:include page="/extn/om/incident/detail/audit/nwcg_new_incident_detail_audit_list_expand.jsp" flush="true">
