...
//System.out.println("request DOM ==>> "+ getRequestDOM());
...
//System.out.println("iTotalReceiptLine ==> "+iTotalReceiptLine);
%>
								...
								if(SerializedFlag=="Y")
								{
										...
										//------------Adding 
											for(cntr1=0;cntr1<RetQty;cntr1++)
											{
													...
													// CR 217 Begin	
													var RowWOSec ='<td>Trackable ID:</td>&nbsp;&nbsp;&nbsp;&nbsp;<td><input type="text"  size=30 maxLength=40 value="" class="unprotectedinput"  id="'+cntr1+'" onblur="trim(this); updateTrackableIDLookup(this); fetchDataWithParams(this,\'checkSerialNo\',PopupMessage,setParamPrimSerial(this));" name="xml:/Receipt/ReceiptLines/ReceiptLine_'+divcount+'/SerialInfoMainItem_'+cntr1+'/@PrimarySerialNo"/><img class="lookupicon" onclick="callTrackableIDLookup(this,\'xml:/Receipt/@SerialList\',\'xml:/Receipt/ReceiptLines/ReceiptLine_'+divcount+'/SerialInfoMainItem_'+cntr1+'/@PrimarySerialNo\',\'xml:/Receipt/ReceiptLines/ReceiptLine_'+divcount+'/SerialInfoMainItem_'+cntr1+'/@SecondarySerialNo\',\'xml:/Receipt/ReceiptLines/ReceiptLine_'+divcount+'/SerialInfoMainItem_'+cntr1+'/@TagAttribute1\',\'xml:/Receipt/ReceiptLines/ReceiptLine_'+divcount+'/SerialInfoMainItem_'+cntr1+'/@TagAttribute2\',\'xml:/Receipt/ReceiptLines/ReceiptLine_'+divcount+'/SerialInfoMainItem_'+cntr1+'/@TagAttribute3\',\'xml:/Receipt/ReceiptLines/ReceiptLine_'+divcount+'/SerialInfoMainItem_'+cntr1+'/@TagAttribute4\',\'xml:/Receipt/ReceiptLines/ReceiptLine_'+divcount+'/SerialInfoMainItem_'+cntr1+'/@TagAttribute5\',\'xml:/Receipt/ReceiptLines/ReceiptLine_'+divcount+'/SerialInfoMainItem_'+cntr1+'/@TagAttribute6\',\'xml:/Receipt/ReceiptLines/ReceiptLine_'+divcount+'/SerialInfoMainItem_'+cntr1+'/@ManufacturingDate\',\'NWCGTrackableIDLookup\',\'&xml:/Serial/@IncidentNo='+IncidentNo+'&xml:/Serial/InventoryItem/@ItemID='+ItemID1+'&xml:/Serial/@IncidentYear='+IncidentYear+'&xml:/Serial/@IssueNo='+IssueNo+'&xml:/Serial/@CacheID='+CacheId+'&xml:/Serial/InventoryItem/@ParentItemID='+PItemID+'&xml:/Serial/@NoOfSecSerials='+NumSecondarySerials+'\')" src="/yantra/console/icons/lookup.gif\" alt="Search for Trackable ID"/></td>&nbsp;&nbsp;<td><input type="hidden" name="PC" value="'+PC+'"></td><td><input type="hidden" name="UOM" value="'+UOM+'"></td><td><input type="hidden" name="ITEMID" value="'+ItemID1+'"></td><TD noWrap><SELECT class=combobox name="xml:/Receipt/ReceiptLines/ReceiptLine_'+divcount+'/SerialInfoMainItem_'+cntr1+'/@DispositionCode"  OldValue=""> <OPTION value=RFI selected>RFI</OPTION> <OPTION value=NRFI>NRFI</OPTION> <OPTION value=UnsRet>UnsRet</OPTION><OPTION value=UnsRetNWT>UnsRetNWT</OPTION></SELECT> </TD><tr></tr>';
													// CR 217 End	
													//Adding time sensitive in serial  line
													TimesenitiveRow = '<td>Expiration  Date:-</td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<TD noWrap><INPUT class=dateinput READONLY onblur=onBlurHandler() size=8 value="" name="xml:/Receipt/ReceiptLines/ReceiptLine_'+divcount+'/SerialInfoMainItem_'+cntr1+'/@ExpiryDate" dataType="DATE" OldValue=""> <IMG class=lookupicon onclick="invokeCalendar(this);return false" alt=Calendar src="/yantra/console/icons/calendar.gif"> </TD><td><input type="hidden" class="unprotectedinput" value="Hide" name="xml:/Receipt/ReceiptLines/ReceiptLine_'+divcount+'/SerialInfoMainItem_'+cntr1+'/@TAttribute" /></td>';
												...
												//if(SerializedFlag[cnt1]!="Y"){
													...
													*/
													...
													if(TimeSensitive[cnt1]=="Y" && SerializedFlag[cnt1]!="Y"){
														...
														var newRow = tblBody.insertRow();
														var newCell0 = newRow.insertCell(0);
														TimesenitiveRow = '<td>Expiration  Date:-</td>&nbsp;&nbsp;&nbsp;&nbsp;<TD noWrap><INPUT class=dateinput onblur=onBlurHandler() size=8 value="" name="xml:/Receipt/ReceiptLines/ReceiptLine_'+inputElid+'/Components/Component_'+cnt1+'/SerialInfo_'+cnt1+'/@ExpiryDate" dataType="DATE" OldValue=""> <IMG class=lookupicon onclick="invokeCalendar(this);return false" alt=Calendar src="/yantra/console/icons/calendar.gif"> </TD><td><input type="hidden" class="unprotectedinput" value="Hide" name="xml:/Receipt/ReceiptLines/ReceiptLine_'+inputElid+'/Components/Component_'+cnt1+'/SerialInfo_'+cnt1+'/@TAttribute" /></td>';
														finalRow = finalRow + TimesenitiveRow;
														newCell0.innerHTML = finalRow;
...
<table  class=table id="ChildTable1" width="100%" counter="0">
		...
		%>
		  ...
		  <!-- ERROR -->
			...
			<IMG class=lookupicon id="<%="LOOKUP"+index %>" onclick="templateRowCallItemLookup(this,'ItemID','ProductClass','UnitOfMeasure','item','xml:/Item/@CallingOrganizationCode=' +  document.all['xml:/Shipment/@EnterpriseCode'].value )" alt="Search for Item" src="/yantra/console/icons/lookup.gif"/>&nbsp;&nbsp;
     ...
     <%  
      ...
      %>
	   ...
	   <tr>
	   <td>Expiration Date:-
	   <INPUT class=dateinput onblur=onBlurHandler() size=8 value="<%=Edate%>" name=xml:/Receipt/ReceiptLines/ReceiptLine_<%=index%>/TimeExpiryMainItem/@ExpiryDate dataType="DATE" OldValue=""> <IMG class=lookupicon onclick="invokeCalendar(this);return false" alt=Calendar src="/yantra/console/icons/calendar.gif">
    ...
    <%} //iTotalTags END IF %>
	 ...
	 <!-- // CR 217 & 693  Begin	 -->
	  ...
	  Expiration Date:-
	  <input class=dateinput onblur=onBlurHandler() size=8 value="<%=ESdate%>" name=xml:/Receipt/ReceiptLines/ReceiptLine_<%=index%>/SerialInfoMainItem_<%=k%>/@ExpiryDate dataType="DATE" OldValue=""> <IMG class=lookupicon onclick="invokeCalendar(this);return false" alt=Calendar src="/yantra/console/icons/calendar.gif"> 
	...
	%>  
      ...
      %>
	   ...
	   <tr>
	   <td>Expiration Date:-
	   <INPUT class=dateinput onblur=onBlurHandler() size=8 value="<%=ECdate%>" name=xml:/Receipt/ReceiptLines/ReceiptLine_<%=index%>/Components/Component_<%=j%>/SerialInfo/@ExpiryDate dataType="DATE" OldValue=""> <IMG class=lookupicon onclick="invokeCalendar(this);return false" alt=Calendar src="/yantra/console/icons/calendar.gif">
 ...
 %>
	...
	<TR>
		<TD align=left>
			...
			<TR>
			<TD>
			<IMG class=icon style="WIDTH: 12px; HEIGHT: 12px" onclick=addRows(this) alt="Add/Copy Row" src="/yantra/console/icons/add.gif">
