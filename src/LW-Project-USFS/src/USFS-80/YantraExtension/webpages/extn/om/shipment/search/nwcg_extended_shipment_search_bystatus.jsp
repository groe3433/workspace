    ...
    <tr>
        <td nowrap="true" class="searchcriteriacell">
            <select name="xml:/Shipment/@ShipmentNoQryType" class="combobox">
                <yfc:loopOptions binding="xml:/QueryTypeList/StringQueryTypes/@QueryType" name="QueryTypeDesc" value="QueryType" selected="xml:/Shipment/@ShipmentNoQryType"/>
            </select>
    ...
    <tr>
        <td nowrap="true" class="searchcriteriacell">            
			<select name="xml:/Shipment/ShipmentLines/ShipmentLine/@OrderNoQryType" class="combobox">
                <yfc:loopOptions binding="xml:/QueryTypeList/StringQueryTypes/@QueryType" name="QueryTypeDesc" value="QueryType" selected="xml:/Shipment/ShipmentLines/ShipmentLine/@OrderNoQryType"/>
            </select>
...
<tr>
  <td class="searchcriteriacell">
          <select class=combobox <%=getComboOptions("xml:/Shipment/ShipmentLines/ShipmentLine/@OrderType")%>>
            <yfc:loopOptions binding="xml:ISOTypeList:/CommonCodeList/@CommonCode" name="CodeShortDescription" value="CodeValue" selected="xml:/Shipment/ShipmentLines/ShipmentLine/@OrderType" isLocalized="Y"/>
          </select>
  </td>
</tr>
<!--  End CR383 Order_Type -->
    ...
    <tr>
        <td nowrap="true" class="searchcriteriacell">
            <select name="xml:/Shipment/@ShipNodeQryType" class="combobox">
                <yfc:loopOptions binding="xml:/QueryTypeList/StringQueryTypes/@QueryType" name="QueryTypeDesc" value="QueryType" selected="xml:/Shipment/@ShipNodeQryType"/>
            </select>
			...
			<img class="lookupicon" onclick="callLookup(this,'shipnode','<%=extraParams%>')" <%=getImageOptions(YFSUIBackendConsts.LOOKUP_ICON, "Search_for_ShipNode") %> />
        </td>
    </tr>
    ...
    <tr>
        <td nowrap="true" class="searchcriteriacell">
            <select name="xml:/Shipment/@ReceivingNodeQryType" class="combobox">
                <yfc:loopOptions binding="xml:/QueryTypeList/StringQueryTypes/@QueryType" name="QueryTypeDesc" value="QueryType" selected="xml:/Shipment/@ReceivingNodeQryType"/>
            </select>
            <input type="text" class="unprotectedinput" <%=getTextOptions("xml:/Shipment/@ReceivingNode")%>/>
			<% String sExtraParams = getExtraParamsForTargetBinding("xml:/Organization/EnterpriseOrgList/OrgEnterprise/@EnterpriseOrganizationKey", getValue("CommonFields", "xml:/CommonFields/@EnterpriseCode")); %>
			<img class="lookupicon" onclick="callLookup(this,'shipnode','<%=sExtraParams%>')" <%=getImageOptions(YFSUIBackendConsts.LOOKUP_ICON, "Search_for_ShipNode") %> />
        </td>
    </tr>
