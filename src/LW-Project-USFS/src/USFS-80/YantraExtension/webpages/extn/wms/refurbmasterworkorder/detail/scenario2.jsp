...
<tr>
	<td class="detaillabel">Item to be Refurbished</td><td class="protectedtext">000159 </td>
	<td class="detaillabel">Item Description</td><td class="protectedtext">CHAIN SAW - 20'' to 24'' bar</td>
...
<tr>
	<td class="detaillabel">Date Last Tested</td><td><input type="text" class="unprotectedinput" <%=getTextOptions("xml:/WorkOrder/WorkOrderComponents/WorkOrderComponent_/@ItemID")%>/></td>
	<td class="detaillabel">Manufacturer</td><td><input type="text" class="unprotectedinput"  <%=getTextOptions("xml:/WorkOrder/WorkOrderComponents/WorkOrderComponent_/@ItemID")%>/></td>
	<td class="detaillabel">Model No</td><td><input type="text" class="unprotectedinput" <%=getTextOptions("xml:/WorkOrder/WorkOrderComponents/WorkOrderComponent_/@ItemID")%>/></td>
</tr>
</table>
<div>
<br>
	...
	<% if(modifyView == ""){%>
		<tfoot>
			...
			<td nowrap="true" class="tablecolumn" style="width:50px">
				<input type="text" class="unprotectedinput"  style="width:50px"  value="000344" <%=getTextOptions("xml:/WorkOrder/WorkOrderComponents/WorkOrderComponent_/@ItemID")%>/>
			...
			<td class="tablecolumn" style="width:150px"> PLUG - spark; chainsaw<yfc:getXMLValue binding="xml:/WorkOrderComponent/Item/PrimaryInformation/@Description"/></td>
			...
			<td nowrap="true" class="tablecolumn" style="width:50px">
				<input type="text" class="unprotectedinput"  style="width:50px" value="007200 " <%=getTextOptions("xml:/WorkOrder/WorkOrderComponents/WorkOrderComponent_/@ItemID")%>/>
				<img class="lookupicon" onclick="templateRowCallItemLookup(this,'ItemID','ProductClass','Uom','item' ,'xml:/Item/@CallingOrganizationCode=' +  document.all['xml:/WorkOrder/@EnterpriseCodeForComponent'].value )" <%=getImageOptions(YFSUIBackendConsts.LOOKUP_ICON, "Search_for_Item")%>/>
			</td>
			<td class="tablecolumn" style="width:150px"> CHAIN <yfc:getXMLValue binding="xml:/WorkOrderComponent/Item/PrimaryInformation/@Description"/></td>
			<td nowrap="true" class="tablecolumn" style="width:60px">
				<select class="combobox" style="width:60px"  <%=getComboOptions("xml:/WorkOrder/WorkOrderComponents/WorkOrderComponent_/@ProductClass")		%>>
				<yfc:loopOptions binding="xml:WorkOrderProductClassList:/CommonCodeList/@CommonCode"
					name="CodeValue" value="CodeValue" selected="xml:/WorkOrder/WorkOrderComponents/WorkOrderComponent_/@ProductClass"/>
