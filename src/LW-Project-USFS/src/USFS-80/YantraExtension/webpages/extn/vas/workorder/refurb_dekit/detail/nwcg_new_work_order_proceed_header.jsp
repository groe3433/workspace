...
%>
	...
	<Input type="hidden" name="xml:/WorkOrder/@ServiceItemGroupCode" value="DKIT")"/>
...
<!--				<input class="unprotectedinput" type="text" <%=getTextOptions("xml:/WorkOrder/@ServiceItemID")%>/>-->
			<input class="unprotectedinput" type="text" name="xml:/WorkOrder/@ServiceItemID" value="REFURB-DEKIT"/>
			...
			<!--	<img class="lookupicon" name="search" onclick="callServiceItemLookup('xml:/WorkOrder/@ServiceItemID','xml:/WorkOrder/@ProductClass','xml:/WorkOrder/@Uom', 'item','<%=resolveValue("xml:/WorkOrder/@ServiceItemGroupCode")%>','<%=extraParams%>')" <%=getImageOptions(YFSUIBackendConsts.LOOKUP_ICON, "Search_for_Service_Item")%> /> -->
					<img class="lookupicon" name="search" onclick="callServiceItemLookup('xml:/WorkOrder/@ServiceItemID','xml:/WorkOrder/@ProductClass','xml:/WorkOrder/@Uom', 'item','DKIT','<%=extraParams%>')" <%=getImageOptions(YFSUIBackendConsts.LOOKUP_ICON, "Search_for_Service_Item")%> />
			</td>
