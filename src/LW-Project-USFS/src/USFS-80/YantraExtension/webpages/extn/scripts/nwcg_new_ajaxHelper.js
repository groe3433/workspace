...
<SCRIPT language="Javascript" src="/yantra/extn/scripts/ajaxHelper.js"/>
...
//var strURL ="/yantra/console/ajaxcontroller.detail"; // need to externalize this or get it from the context
var strURL ="/yantra/AjaxServlet";
...
function AJAXWrapper()
{
	...
	this.beforeLoading = function(elem,xmlDoc){
		...
		if(imgNodeList!=null){
			...
			imgNode.setAttribute("src","/yantra/extn/icons/searching.gif");
