...
<%	
	System.out.println("@@@@@ /webpages/extn/rf/wms/rfnwcgrfireturns/frmNRFILinesInitValtxtItemID.jsp");
...
<%
	...
	YFCDocument ydoc = getForm("/frmNRFILinesInit");
	
	if(sIsSerialTracked.equalsIgnoreCase("Y")) {
		formName = "/frmNRFILinesTrkID" ;
	 	ydoc=getForm("/frmNRFILinesTrkID");
	} else {
		// calculate total no of lines 
		formName = "/frmNRFILines" ;	
	}
...
<%
		...
		if(formName.equalsIgnoreCase("/frmNRFILines")) {
