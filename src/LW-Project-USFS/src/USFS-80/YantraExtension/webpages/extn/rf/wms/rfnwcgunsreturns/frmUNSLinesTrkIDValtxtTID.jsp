...
<%
	System.out.println("@@@@@ /webpages/extn/rf/wms/rfnwcgrfireturns/frmUNSLinesTrkIDValtxtTID.jsp");
...
<%
		...
		if (strRsult == "NotInIncident") {
			errorDesc = "INVALID TRACKABLE ID FOR THIS INCIDENT !!!";
		}
		if (strRsult == "Invalid Input") {
...
<%
			...
			receiptLineMap.put("DispositionCode", "UnsRet");
			...
			YFCDocument doc=getForm("/frmUNSLinesTrkID");
			String strValue = "0";
			...
			String formName = "/frmUNSLinesTrkID" ;	
