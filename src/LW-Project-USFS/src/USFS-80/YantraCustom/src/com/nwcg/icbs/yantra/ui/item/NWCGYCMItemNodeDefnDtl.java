 ...
 * YCMModifyItem.java
 *
 * Created on March 7, 2001, 11:20 AM
 */
 ...
 * @version
 */
public class NWCGYCMItemNodeDefnDtl extends com.yantra.ycm.ui.screens.forms.YCMItemNodeDefnDtl {
    ...
    private void initComponents() {
        ...
        panelModifyItemNodeKey.setBorder(javax.swing.BorderFactory.createTitledBorder(""));
        ...
        lkpItemID.setCreateNewActionId(YCMUIConsts.YCM_ITEM_LIST_SCREEN_CREATE_ACTION);
        lkpItemID.setSearchActionId(YCMUIConsts.YCM_SIMPLE_SEARCH);
        lkpItemID.setName("xml:/ItemNodeDefn@ItemID");
        lkpItemID.putClientProperty("YFCXMLBinding.listName", "xml:/ItemNodeDefn/MasterData/Items@Item");
        lkpItemID.putClientProperty("YFCXMLBinding.codeAttribute", "ItemID");
        lkpItemID.putClientProperty("YFCXMLBinding.descriptionAttribute", "ItemID");
        ...
        lkpItemID.setLookupSearchElement("<SearchElement>\n\t<DynamicAttributes OrganizationCode=\"@CallingOrganizationCode\"/>\n</SearchElement>");
        lkpItemID.setLookupCreateElement("<CreateElement>\n\t<DynamicAttributes OrganizationCode=\"@CallingOrganizationCode\"/>\n</CreateElement>");
        ...
        lkpUOM.putClientProperty("YFCXMLBinding.listName", "xml:/ItemNodeDefn/MasterData/UOMs@ItemUOMMaster");
        lkpUOM.putClientProperty("YFCXMLBinding.codeAttribute", "UnitOfMeasure");
        lkpUOM.putClientProperty("YFCXMLBinding.descriptionAttribute", "Description");
        ...
        lkpNode.putClientProperty("YFCXMLBinding.descriptionAttribute", "ShipnodeKey");
        lkpNode.putClientProperty("YFCXMLBinding.listName", "xml:/ItemNodeDefn/MasterData/Nodes@ShipNode");
        ...
        txtDescription.setName("xml:/ItemNodeDefn/Item/PrimaryInformation@ShortDescription");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 2;
        ...
        pnlItemNodeClassificationDefaults.setLayout(new java.awt.GridBagLayout());

        pnlItemNodeClassificationDefaults.setBorder(javax.swing.BorderFactory.createTitledBorder(getString("Operational_Classification_Node_Override_Values")));
        lblStorageType.setText(getString("Storage_Type"));
        lblStorageType.putClientProperty("YFCClassificationAttribute", "StorageType");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 0;
        gridBagConstraints.fill = java.awt.GridBagConstraints.BOTH;
        gridBagConstraints.insets = new java.awt.Insets(0, 5, 5, 5);
        pnlItemNodeClassificationDefaults.add(lblStorageType, gridBagConstraints);

        lblPickingType.setText(getString("Picking_Type"));
        lblPickingType.putClientProperty("YFCClassificationAttribute", "PickingType");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 1;
        gridBagConstraints.fill = java.awt.GridBagConstraints.BOTH;
        gridBagConstraints.insets = new java.awt.Insets(0, 5, 5, 5);
        pnlItemNodeClassificationDefaults.add(lblPickingType, gridBagConstraints);

        lblVelocityCode.setText(getString("Velocity_Code"));
        lblVelocityCode.putClientProperty("YFCClassificationAttribute", "VelocityCode");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 2;
        gridBagConstraints.fill = java.awt.GridBagConstraints.BOTH;
        gridBagConstraints.insets = new java.awt.Insets(0, 5, 5, 5);
        pnlItemNodeClassificationDefaults.add(lblVelocityCode, gridBagConstraints);

        chkOperationalConfigComplete.setText(getString("Operational_Configuration_Complete"));
        chkOperationalConfigComplete.setName("xml:/ItemNodeDefn@OperationalConfigurationComplete");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        ...
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.insets = new java.awt.Insets(0, 5, 5, 5);
        pnlItemNodeClassificationDefaults.add(chkOperationalConfigComplete, gridBagConstraints);
        ...
        pnlClassifications.add(pnlItemNodeClassificationDefaults, gridBagConstraints);

        pnlItemClassificationDefaults.setLayout(new java.awt.GridBagLayout());

        pnlItemClassificationDefaults.setBorder(javax.swing.BorderFactory.createTitledBorder(getString("Operational_Classification_Item_Defaults")));
        chkItemOperationalConfigComplete.setText(getString("Operational_Configuration_Complete"));
        chkItemOperationalConfigComplete.setName("xml:/ItemNodeDefn/Item/ClassificationCodes@OperationalConfigurationComplete");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 3;
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.insets = new java.awt.Insets(0, 5, 5, 5);
        pnlItemClassificationDefaults.add(chkItemOperationalConfigComplete, gridBagConstraints);

        txtItemStorageType.setName("xml:/ItemNodeDefn/Item/ClassificationCodes@StorageType");
        txtItemStorageType.putClientProperty("YFCXMLBinding.dataType","Text-40");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 0;
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.insets = new java.awt.Insets(0, 5, 5, 5);
        pnlItemClassificationDefaults.add(txtItemStorageType, gridBagConstraints);

        txtItemPickingType.setName("xml:/ItemNodeDefn/Item/ClassificationCodes@PickingType");
        txtItemPickingType.putClientProperty("YFCXMLBinding.dataType","Text-40");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 1;
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.insets = new java.awt.Insets(0, 5, 5, 5);
        pnlItemClassificationDefaults.add(txtItemPickingType, gridBagConstraints);

        txtItemVelocityCode.setName("xml:/ItemNodeDefn/Item/ClassificationCodes@VelocityCode");
        txtItemVelocityCode.putClientProperty("YFCXMLBinding.dataType","Text-40");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 2;
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.insets = new java.awt.Insets(0, 5, 5, 5);
        pnlItemClassificationDefaults.add(txtItemVelocityCode, gridBagConstraints);
        ...
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        pnlItemClassificationDefaults.add(itemDefaultFiller, gridBagConstraints);
        ...
        pnlClassifications.add(pnlItemClassificationDefaults, gridBagConstraints);
		...
		pnlClassificationFiller.setBorder(javax.swing.BorderFactory.createTitledBorder(getString("Additional_Attributes")));
        ...
        gridBagConstraints.insets = new java.awt.Insets(5, 0, 0, 5);
		txtStdRefurbCost.setColumns(10);
		txtExternalRefurbCost.setName("xml:/ItemNodeDefn/Extn@ExtnExternalRefurbCost");
