...
//	also make all the methods except entry method to private
...
public class NWCGCreateOtherIssuUsingReservedItems implements YIFCustomApi {
    	
	    private Properties _properties;
	    private static YFCLogCategory log = YFCLogCategory.instance(NWCGgetReservedItems.class);
	    ...
	    public Document createOrder(YFSEnvironment env, Document inXML) throws YFSException
	    {
	    	if(logger.isVerboseEnabled()){
	    		logger.debug("Start of NWCGCreteOtherOrderUSingReservedItemsAPI");
	    	}//End if 
	        ...
	        try{
		        ...
		        //System.out.println("\n\n Inside createOtherIssueFor Reserved Items API:-\n"+ XMLUtil.getXMLString(inXML));
		        ...
		        for(int i=0;i<itemListLength;i++)
		        {
		        	...
		        	if(!(itemNode.getAttribute("QTY").equals("")) && itemNode.getAttribute("QTY")!=null){
		        		...
		        		//System.out.println("QTY is zero");
		        		itemDetails.add("0");
		        		continue;
		        	}//End if 
		       ...
		       //System.out.println( "FinalMap.size = " + FinalMap.size());
		        ...
		        el_Order.setAttribute("DocumentType",NWCGConstants.NWCG_RESERVATION_OTHER_ISSUE_DOC);
		       ...
		       for(int cnt=0; cnt<ItemListLength;cnt++){
		    	    ...
		    	    if(!(SelectedItem.getAttribute("selectedQTY").equals(""))&& SelectedItem.getAttribute("selectedQTY")!=null){ 
		        	 ...
		        	 //==========
				        ...
				        //System.out.println("End of round....007.ex");
		        }//End for loop
	        ...
	        //Element rootNode = inXML.getDocumentElement();
	        //System.out.println("CreateOrder input document is :-"+XMLUtil.getXMLString(CreateOrderInputDoc));
	        ...
	        //-------------------------------------------------------------------
	        if(logger.isVerboseEnabled()){
	        	logger.debug("End of NWCGCreateOtherOrderUSingReservedItemsAPI");
	        }//End if 
