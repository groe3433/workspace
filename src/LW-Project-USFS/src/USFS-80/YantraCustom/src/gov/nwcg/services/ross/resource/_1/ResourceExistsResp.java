 ...
 *         &lt;element name="OwningSystem" type="{http://nwcg.gov/services/ross/common_types/1.1}ApplicationSystemType" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "ResourceExistsResp")
public class ResourceExistsResp {

    @XmlElement(name = "ResponseStatus", required = true)
    protected ResponseStatusType responseStatus;
    @XmlElement(name = "ResourceKey")
    protected CompositeResourceKeyType resourceKey;
    @XmlElement(name = "OwningSystem")
    protected ApplicationSystemType owningSystem;
     ...
     *     
     */
    public ApplicationSystemType getOwningSystem() {
        return owningSystem;
    }
     ...
     *     
     */
    public void setOwningSystem(ApplicationSystemType value) {
        this.owningSystem = value;
    }

    public boolean isSetOwningSystem() {
        return (this.owningSystem!= null);
    }
