 ...
 *         &lt;element name="ActiveInExtSystemInd" type="{http://www.w3.org/2001/XMLSchema}boolean"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "", propOrder = {
    "messageOriginator",
    "incidentKey",
    "activeInExtSystemInd"
})
@XmlRootElement(name = "SetIncidentActivationReq")
public class SetIncidentActivationReq {
    ...
    @XmlElement(name = "ActiveInExtSystemInd")
    protected boolean activeInExtSystemInd;
    ...
    /**
     * Gets the value of the activeInExtSystemInd property.
     * 
     */
    public boolean isActiveInExtSystemInd() {
        return activeInExtSystemInd;
    }

    /**
     * Sets the value of the activeInExtSystemInd property.
     * 
     */
    public void setActiveInExtSystemInd(boolean value) {
        this.activeInExtSystemInd = value;
    }

    public boolean isSetActiveInExtSystemInd() {
        return true;
    }
