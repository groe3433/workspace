...
import gov.nwcg.services.ross.common_types._1.ResourceAvailabilityType;
 ...
 *         &lt;element name="ResourceAvailability" type="{http://nwcg.gov/services/ross/common_types/1.1}ResourceAvailabilityType"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "UpdateResourceAvailabilityReq")
public class UpdateResourceAvailabilityReq {
    ...
    @XmlElement(name = "ResourceAvailability", required = true)
    protected ResourceAvailabilityType resourceAvailability;
     ...
     * @return
     *     possible object is
     *     {@link ResourceAvailabilityType }
     *     
     */
    public ResourceAvailabilityType getResourceAvailability() {
     ...
     *     
     */
    public void setResourceAvailability(ResourceAvailabilityType value) {
        this.resourceAvailability = value;
    }

    public boolean isSetResourceAvailability() {
        return (this.resourceAvailability!= null);
    }
