 ...
 *         &lt;element name="DuplicateResourceKey" type="{http://nwcg.gov/services/ross/common_types/1.1}CompositeResourceKeyType"/>
...
@XmlRootElement(name = "DeleteDuplicatePersonResourceReq")
public class DeleteDuplicatePersonResourceReq {

    @XmlElement(name = "MessageOriginator", required = true)
    protected MessageOriginatorType messageOriginator;
    @XmlElement(name = "DuplicateResourceKey", required = true)
    protected CompositeResourceKeyType duplicateResourceKey;
    ...
    /**
     * Gets the value of the duplicateResourceKey property.
     * 
     * @return
     *     possible object is
     ...
     *     
     */
    public CompositeResourceKeyType getDuplicateResourceKey() {
        return duplicateResourceKey;
    }

    /**
     * Sets the value of the duplicateResourceKey property.
     * 
     * @param value
     *     allowed object is
     *     {@link CompositeResourceKeyType }
     *     
     */
    public void setDuplicateResourceKey(CompositeResourceKeyType value) {
        this.duplicateResourceKey = value;
    }

    public boolean isSetDuplicateResourceKey() {
        return (this.duplicateResourceKey!= null);
    }
