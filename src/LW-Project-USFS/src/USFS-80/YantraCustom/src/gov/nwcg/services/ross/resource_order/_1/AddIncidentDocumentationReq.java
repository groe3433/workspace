 ...
 *         &lt;element name="DocumentationText" type="{http://nwcg.gov/services/ross/common_types/1.1}DocumentationTextSimpleType"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "AddIncidentDocumentationReq")
public class AddIncidentDocumentationReq {
    ...
    @XmlElement(name = "DocumentationText", required = true)
    ...
    /**
     * Gets the value of the documentationText property.
     * 
     * @return
     *     possible object is
     *     {@link String }
    ...
    /**
     * Sets the value of the documentationText property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setDocumentationText(String value) {
        this.documentationText = value;
    }

    public boolean isSetDocumentationText() {
        return (this.documentationText!= null);
    }
