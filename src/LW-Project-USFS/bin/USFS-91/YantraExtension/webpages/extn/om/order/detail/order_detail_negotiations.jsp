...
<td class="tablecolumn" sortValue="<%=getNumericValue("xml:Negotiation:/Negotiation/@NegotiationNo")%>">
...
<td class="tablecolumn">
<%=displayOrderStatus("N", getValue("Negotiation","xml:/Negotiation/@StatusDescription"))%>
</td>
</tr>
</yfc:loopXML>
</tbody>
