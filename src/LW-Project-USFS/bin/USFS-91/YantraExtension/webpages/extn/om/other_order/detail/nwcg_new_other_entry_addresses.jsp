...
<td>
<input type="text" class="unprotectedinput"  maxLength='30' <%=getTextOptions(Path+"/@AddressLine1")%>>&nbsp;
</td>
</tr>
<tr>
<td class="detaillabel" ><yfc:i18n>Address_Line_2</yfc:i18n></td>
<td>
<input type="text" class="unprotectedinput"  maxLength='30' <%=getTextOptions(Path+"/@AddressLine2")%>>&nbsp;
</td>
</tr>
<tr>
<td class="detaillabel" ><yfc:i18n>Address_Line_3</yfc:i18n></td>
<td>
<input type="text" class="unprotectedinput" maxLength='30'  <%=getTextOptions(Path+"/@AddressLine3")%>>&nbsp;
</td>
</tr>
<tr>
<td class="detaillabel" ><yfc:i18n>Address_Line_4</yfc:i18n></td>
<td>
<input type="text" class="unprotectedinput"  maxLength='30' <%=getTextOptions(Path+"/@AddressLine4")%> >&nbsp;
</td>
</tr>
<tr>
<td class="detaillabel" ><yfc:i18n>Address_Line_5</yfc:i18n></td>
<td>
<input type="text" class="unprotectedinput" maxLength='30'  <%=getTextOptions(Path+"/@AddressLine5")%> >&nbsp;
</td>
</tr>
<tr>
<td class="detaillabel" ><yfc:i18n>Address_Line_6</yfc:i18n></td>
<td>
<input type="text" class="unprotectedinput" maxLength='30'  <%=getTextOptions(Path+"/@AddressLine6")%> >&nbsp;
</td>
</tr>
<tr>
...
<td>
<INPUT type=radio value="" name="<%=Path+"/@Company"%>">Residence</Input>
</td>
</tr>
<tr>
<td>&nbsp;</td>
...
<td>
<input type="text" class="unprotectedinput" name="xml:/Customer/@CustomerID"  id="xml:/Customer/@CustomerID" onblur="javascript:fetchDataFromServer(this,'getCustomerList',displayCustomerList<%=Path.substring(Path.lastIndexOf("/")+1,Path.length())%>)"/>
