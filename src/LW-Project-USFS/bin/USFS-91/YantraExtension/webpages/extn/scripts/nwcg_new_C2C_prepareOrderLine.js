...
function populateBlankRow(documentType,driverDate,strPCData,strUOMData,counter) {
	...
	var strDate = '<td class="tablecolumn" nowrap="true"> ' ;
	if (driverDate == "02") { 
		strDate = strDate + '<input type="text" OldValue="" style=\'width:70px\' class=\'unprotectedoverrideinput\'  name="xml:/Order/OrderLines/OrderLine_'+counter+'/@ReqDeliveryDate"/> <img class="lookupicon" onclick="invokeCalendar(this)" src="/smcfs/console/icons/calendar.gif" />' ;
	} else { 
		strDate = strDate + '<input type="text" OldValue="" style=\'width:70px\' class=\'unprotectedoverrideinput\'  name="xml:/Order/OrderLines/OrderLine_'+counter+'/@ReqShipDate"/> <img class="lookupicon" onclick="invokeCalendar(this)" src="/smcfs/console/icons/calendar.gif"/> ' ;
	} 
	strDate = strDate + '</td> ' ;
...
function populateBlankRow_CreateCacheRequest(documentType,driverDate,strPCData,strUOMData,counter) {
	...
	strItemID = strItemID + 'onBlur="fetchDataWithParams(this,\'PopulateItemDetails\',populateItemForCacheRequestDetails,setC2CParam(this))"/> <img class="lookupicon" ' ;
	strItemID= strItemID +  'onclick="templateRowCallItemLookup(this,\'ItemID\',\'ProductClass\',\'TransactionalUOM\',\'item\',\'<%=extraParams%>\')" src=\'/smcfs/console/icons/lookup.gif\'/><font size=7></font></td>' ;
	...
	var strDate = '<td class="tablecolumn" nowrap="true"> ' ;
	if (driverDate == "02") { 
		strDate = strDate + '<input type="text" OldValue="" style=\'width:90px\' style=\'height:25px\' style=\'font-size:14px\' class=\'unprotectedoverrideinput\'  name="xml:/Order/OrderLines/OrderLine_'+counter+'/@ReqDeliveryDate"/> <img class="lookupicon" onclick="invokeCalendar(this)" src="/smcfs/console/icons/calendar.gif" />' ;
	} else { 
		strDate = strDate + '<input type="text" OldValue="" style=\'width:90px\' style=\'height:25px\' style=\'font-size:14px\' class=\'unprotectedoverrideinput\'  name="xml:/Order/OrderLines/OrderLine_'+counter+'/@ReqShipDate"/> <img class="lookupicon" onclick="invokeCalendar(this)" src="/smcfs/console/icons/calendar.gif"/> ' ;
	}
	strDate = strDate + '</td> ' ;
