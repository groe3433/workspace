...
$SSHPASS/sshpass -p $2 ssh -o StrictHostKeyChecking=no $1@nn604ap001.nwcg.gov "echo $2 | sudo -S -u was /opt/apps/projects/Sterling_Deployer/Restart/stopICBSRNodeAgentServers.sh";

echo "***** Full Restart Script:: Stop Node Agent (ICBSR02)";
$SSHPASS/sshpass -p $2 ssh -o StrictHostKeyChecking=no $1@nn604ap002.nwcg.gov "echo $2 | sudo -S -u was /opt/apps/projects/Sterling_Deployer/Restart/stopICBSRNodeAgentServers.sh";
echo "Allowing 10 seconds for this activity...";
sleep 10;

echo "***** Full Restart Script:: Stop Deployment Manager";
$SSHPASS/sshpass -p $2 ssh -o StrictHostKeyChecking=no $1@nn604dm001.nwcg.gov "echo $2 | sudo -S -u was /opt/apps/projects/Sterling_Deployer/Restart/stopICBSRDeploymentManager.sh";
echo "Allowing 10 seconds for this activity...";
sleep 10;

echo "***** Full Restart Script:: Start Deployment Manager";
$SSHPASS/sshpass -p $2 ssh -o StrictHostKeyChecking=no $1@nn604dm001.nwcg.gov "echo $2 | sudo -S -u was /opt/apps/projects/Sterling_Deployer/Restart/startICBSRDeploymentManager.sh";
echo "Allowing 10 seconds for this activity...";
sleep 10;

echo "***** Full Restart Script:: Start Node Agent (ICBSR01)";
$SSHPASS/sshpass -p $2 ssh -o StrictHostKeyChecking=no $1@nn604ap001.nwcg.gov "echo $2 | sudo -S -u was /opt/apps/projects/Sterling_Deployer/Restart/startICBSRNodeAgentServers.sh";

echo "***** Full Restart Script:: Start Node Agent (ICBSR02)";
$SSHPASS/sshpass -p $2 ssh -o StrictHostKeyChecking=no $1@nn604ap002.nwcg.gov "echo $2 | sudo -S -u was /opt/apps/projects/Sterling_Deployer/Restart/startICBSRNodeAgentServers.sh";
echo "Allowing 10 seconds for this activity...";
sleep 10;
