  ...
  CREATE OR REPLACE FORCE VIEW EXTN_NWCG_CRITICAL_ITEM_VW ("ITEM_ID", "UOM", "ITEM_DESCRIPTION", "CACHE ID", "QTY_RFI", "QTY_NRFI", "PREV_DAY_USAGE", "QTY_ALLOC", "QUANTITY_WORDERED", "GLOBAL_ITEM_ID", "UNIT_COST", "LOCAL CRITICAL", "NATIONAL CRITICAL", "GSA PREFERRED", "QTY_MIN", "QTY_MAX", "QTY_DUE", "QTY_RESD") AS 
  SELECT a.item_id,
    a.uom,
    a.item_description,
    a.node_key "CACHE ID",
  ...
  AND a.node_key NOT IN ('HIGH_VOLUME_TEMPLATE','LOW_VOLUME_TEMPLATE')
  AND c.status        = '3000'
  GROUP BY a.item_id,
    a.node_key,
    a.item_description,
