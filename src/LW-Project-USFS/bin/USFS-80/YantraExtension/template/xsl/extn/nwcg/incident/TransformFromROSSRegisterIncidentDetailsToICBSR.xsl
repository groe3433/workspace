...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:ns2="http://nwcg.gov/services/ross/resource_order/1.1" xmlns:ns3="http://nwcg.gov/services/ross/common_types/1.1" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" >
	...
	<xsl:template match="/">
		...
		<xsl:element name="NWCGIncidentOrder">
			...
			<xsl:attribute name="CustomerId"><xsl:value-of select="//ns2:Incident/IncidentDetails/BillingOrganization/UnitIDPrefix"/><xsl:value-of select="//ns2:Incident/IncidentDetails/BillingOrganization/UnitIDSuffix"/></xsl:attribute>
			<xsl:attribute name="DateStarted"><xsl:value-of select="//ns2:Incident/IncidentDetails/InitialDateTime"/></xsl:attribute>
			<xsl:attribute name="IncidentHost"><xsl:value-of select="//ns2:Incident/IncidentKey/NaturalIncidentKey/HostID/UnitIDPrefix"/><xsl:value-of select="//ns2:Incident/IncidentKey/NaturalIncidentKey/HostID/UnitIDSuffix"/></xsl:attribute>
			<xsl:variable name="incName"><xsl:value-of select="//ns2:Incident/IncidentDetails/IncidentName"/></xsl:variable>
			<xsl:attribute name="IncidentName">
				<xsl:value-of select="translate($incName, $lowercase, $uppercase)"/>
			</xsl:attribute>
			<xsl:attribute name="IncidentNo"><xsl:value-of select="//ns2:Incident/IncidentKey/NaturalIncidentKey/HostID/UnitIDPrefix"/>-<xsl:value-of select="//ns2:Incident/IncidentKey/NaturalIncidentKey/HostID/UnitIDSuffix"/>-<xsl:value-of select="//ns2:Incident/IncidentKey/NaturalIncidentKey/SequenceNumber"/></xsl:attribute>
			<xsl:attribute name="IncidentType"><xsl:value-of select="//ns2:Incident/IncidentDetails/IncidentType"/></xsl:attribute>
			<xsl:attribute name="IncidentId"><xsl:value-of select="//ns2:Incident/IncidentKey/IncidentID/EntityID"/></xsl:attribute>
			<xsl:attribute name="LastUpdatedFromROSS"><!--<xsl:value-of select="$currentdatestr" />--></xsl:attribute>
			<xsl:attribute name="ROSSDispatchID"><xsl:value-of select="//ns2:Incident/IncidentDetails/DispatchOrganization/UnitIDPrefix"/>-<xsl:value-of select="//ns2:Incident/IncidentDetails/DispatchOrganization/UnitIDSuffix"/></xsl:attribute>
			<xsl:attribute name="PrimaryCacheId"><xsl:value-of select="//ns2:Incident/IncidentDetails/CacheOrganization/UnitIDPrefix"/><xsl:value-of select="//ns2:Incident/IncidentDetails/CacheOrganization/UnitIDSuffix"/></xsl:attribute>
			<xsl:for-each select="//ns2:Incident/IncidentEntities/IncidentFinancialCodes">
			...
			<xsl:attribute name="ROSSIncidentStatus"><xsl:value-of select="//ns2:Incident/IncidentDetails/Status"/></xsl:attribute>
			<xsl:for-each select="//ns2:Incident/IncidentEntities/IncidentRequestBlocks">
			...
			<xsl:variable name="LatDegreeVal">
				<xsl:value-of select="//ns2:Incident/IncidentDetails/IncidentLocation/GeographicCoordinate/GeographicCoordinateLatitude/LatitudeDegreeValue"/>
			</xsl:variable>
			<xsl:variable name="LatMinuteVal">
				<xsl:value-of select="//ns2:Incident/IncidentDetails/IncidentLocation/GeographicCoordinate/GeographicCoordinateLatitude/LatitudeMinuteValue"/>
			</xsl:variable>
			<xsl:variable name="LatSecondVal">
				<xsl:value-of select="//ns2:Incident/IncidentDetails/IncidentLocation/GeographicCoordinate/GeographicCoordinateLatitude/LatitudeSecondValue"/>
			</xsl:variable>
			<xsl:variable name="LatDirection">
				<xsl:value-of select="//ns2:Incident/IncidentDetails/IncidentLocation/GeographicCoordinate/GeographicCoordinateLatitude/LatitudeDirection"/>
			</xsl:variable>
			...
			<xsl:variable name="LonDegreeVal">
				<xsl:value-of select="//ns2:Incident/IncidentDetails/IncidentLocation/GeographicCoordinate/GeographicCoordinateLongitude/LongitudeDegreeValue"/>
			</xsl:variable>
			<xsl:variable name="LonMinuteVal">
				<xsl:value-of select="//ns2:Incident/IncidentDetails/IncidentLocation/GeographicCoordinate/GeographicCoordinateLongitude/LongitudeMinuteValue"/>
			</xsl:variable>
			<xsl:variable name="LonSecondVal">
				<xsl:value-of select="//ns2:Incident/IncidentDetails/IncidentLocation/GeographicCoordinate/GeographicCoordinateLongitude/LongitudeSecondValue"/>
			</xsl:variable>
			<xsl:variable name="LonDirection">
				<xsl:value-of select="//ns2:Incident/IncidentDetails/IncidentLocation/GeographicCoordinate/GeographicCoordinateLongitude/LongitudeDirection"/>
			</xsl:variable>
			...
			<xsl:element name="NWCGIncidentOrderConInfoList">
				<xsl:for-each select="//ns2:Incident/IncidentEntities/IncidentContacts">
