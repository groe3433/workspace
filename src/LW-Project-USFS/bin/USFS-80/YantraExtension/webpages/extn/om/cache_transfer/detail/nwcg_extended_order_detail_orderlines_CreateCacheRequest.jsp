...
<thead>
<tr>
	<td class="tablecolumnheader" nowrap="true" style="width:125px; font-size:18px"><yfc:i18n>Item_ID</yfc:i18n></td>
	<td class="tablecolumnheader" style="width:80px; font-size:18px"  sortable="no"><yfc:i18n>UOM</yfc:i18n></td>
	<td class="tablecolumnheader" style="width:550px; font-size:18px"  sortable="no"><yfc:i18n>Description</yfc:i18n></td>
	<td class="tablecolumnheader" nowrap="true" sortable="no" style="width:40px; font-size:18px"><yfc:i18n>Requested_Qty</yfc:i18n></td>
	<td class="tablecolumnheader" nowrap="true" sortable="no" style="width:550px; font-size:18px"><yfc:i18n>Comments</yfc:i18n></td>
</tr>
</thead>
 <tbody>
	<!-- This will create the blank panel -->
			<jsp:include page="/extn/common/nwcg_new_render_C2C_orderline_CreateCacheRequest.jsp" flush="true"/>        
    </tbody>
...
<jsp:include page="/extn/common/nwcg_new_render_C2C_orderline_js_CreateCacheRequest.jsp" flush="true"/>