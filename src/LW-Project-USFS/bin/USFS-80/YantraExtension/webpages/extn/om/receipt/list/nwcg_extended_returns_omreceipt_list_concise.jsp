...
<script language="javascript">
	function checkAndMovetoReceive(key,ViewId){
		...
		if(yfcAllowSingleSelection(key)){
			...
			if(ReceiptOpenKey=="Y"){
			showDetailForOnAdvancedList('NWGomreceipt', ViewId, keyval, "") ;
			}else{
...
<table class="table" editable="false" width="100%" cellspacing="0">
    <thead>
        <tr>
            ...
            <td class="tablecolumnheader"><yfc:i18n>Return_Receipt_#</yfc:i18n></td>
	    ...
	    <yfc:loopXML binding="xml:/ReceiptList/@Receipt" id="Receipt" >
            <tr>
				<yfc:makeXMLInput name="receiptKey">
					...
					<yfc:makeXMLKey binding="xml:/Receipt/Extn/@ExtnIncidentNo" value="xml:/Receipt/Extn/@ExtnIncidentNo"> </yfc:makeXMLKey>
					<yfc:makeXMLKey binding="xml:/Receipt/Extn/@ExtnIncidentYear" value="xml:/Receipt/Extn/@ExtnIncidentYear"> </yfc:makeXMLKey>
				</yfc:makeXMLInput>
	            ...
	            <td class="tablecolumn">
      			...
      			<td class="tablecolumn"> 
					<yfc:getXMLValue binding="xml:/Receipt/Extn/@ExtnIncidentNo"/>
				</td>

      			<td class="tablecolumn"> 
					<yfc:getXMLValue binding="xml:/Receipt/Extn/@ExtnIncidentYear"/>
				</td>

	            <!-- <td class="tablecolumn"><yfc:getXMLValue binding="xml:/Receipt/Shipment/@OrderNo"/></td> -->

				<td class="tablecolumn"> 
					<yfc:getXMLValue binding="xml:/Receipt/Shipment/@EnterpriseCode"/>
				</td>
			
				<td class="tablecolumn"> <%=resolveValue("xml:/Receipt/Shipment/@BillToCustomerId")%> </td>
