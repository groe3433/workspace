...
<td>
<input type="text" class="unprotectedinput" maxLength='30' onblur="makeUppercase(this);" <%=getTextOptions(Path+"/@AddressLine1")%>>&nbsp;
</td>
</tr>
<tr>
<td class="detaillabel" ><yfc:i18n>Address_Line_2</yfc:i18n></td>
<td>
<input type="text" class="unprotectedinput" maxLength='30' onblur="makeUppercase(this);" <%=getTextOptions(Path+"/@AddressLine2")%>>&nbsp;
</td>
</tr>
<tr>
<td class="detaillabel" ><yfc:i18n>Address_Line_3</yfc:i18n></td>
<td>
<input type="text" class="unprotectedinput" maxLength='30' onblur="makeUppercase(this);" <%=getTextOptions(Path+"/@AddressLine3")%>>&nbsp;
</td>
</tr>
<tr>
<td class="detaillabel" ><yfc:i18n>Address_Line_4</yfc:i18n></td>
<td>
<input type="text" class="unprotectedinput" maxLength='30' onblur="makeUppercase(this);" <%=getTextOptions(Path+"/@AddressLine4")%>>&nbsp;
</td>
</tr>
<tr>
<td class="detaillabel" ><yfc:i18n>Address_Line_5</yfc:i18n></td>
<td>
<input type="text" class="unprotectedinput" maxLength='30' onblur="makeUppercase(this);" <%=getTextOptions(Path+"/@AddressLine5")%>>&nbsp;
</td>
</tr>
<tr>
<td class="detaillabel" ><yfc:i18n>Address_Line_6</yfc:i18n></td>
<td>
<input type="text" class="unprotectedinput" maxLength='30' onblur="makeUppercase(this);" <%=getTextOptions(Path+"/@AddressLine6")%>>&nbsp;
</td>
</tr>
<tr>
...
<td><input type="hidden" class="unprotectedinput" <%=getTextOptions(Path+"/@MiddleName")%> ></td>
</tr>
<tr>
...
<td><input type="hidden" class="unprotectedinput" <%=getTextOptions(Path+"/@EveningPhone")%> ></td>
</tr>
<tr>
...
<td><INPUT type=radio value="NWCG" name="<%=Path+"/@Company"%>" checked >Business</Input>
</tr>
<tr>
<td>
&nbsp;
...
<td>
<INPUT type=radio value="" name="<%=Path+"/@Company"%>" >Residential</Input>
</td>
</tr>
</span>
<tr>
...
<td>
<input type="text" class="unprotectedinput" name="xml:/Customer/@CustomerID"  id="xml:/Customer/@CustomerID" onblur="makeUppercase(this);javascript:fetchDataFromServer(this,'getCustomerList',displayCustomerList<%=Path.substring(Path.lastIndexOf("/")+1,Path.length())%>)"/>
