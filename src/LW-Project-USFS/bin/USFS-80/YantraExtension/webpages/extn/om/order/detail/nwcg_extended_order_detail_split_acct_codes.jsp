...
<% String totamtstr = resolveValue("xml:/Order/OverallTotals/@GrandTotal"); 
   ...
   //System.out.println("TotAmtStr "+UList); 
   totamtstr = UList;
   //System.out.println("TOTAMTSTR "+totamtstr); 
   %>
...
<% double currenttotamt = amt1+amt2+amt3+amt4+amt5;
   ...
   //System.out.println("Ctotstr " + ctotstr);
   String [] Ctfields = ctotstr.split("[.]");
   //System.out.println("Ctfields[0] "+ Ctfields[0]);
   //System.out.println("Ctfields[1] "+ Ctfields[1]);
