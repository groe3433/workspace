...
<%
	System.out.println("@@@@@ /webpages/extn/rf/wms/rfnwcgrfireturns/frmUNSNWTLinesInitValtxtItemID.jsp");
...
<%
	...
	YFCDocument ydoc = getForm("/frmUNSNWTLinesInit");
	
	if(sIsSerialTracked.equalsIgnoreCase("Y")) {
		formName = "/frmUNSNWTLinesTrkID" ;
	 	ydoc=getForm("/frmUNSNWTLinesTrkID");
	} else {
		// calculate total no of lines 
		formName = "/frmUNSNWTLines" ;	
	}
...
<%
		...
		if(formName.equalsIgnoreCase("/frmUNSNWTLines")) { 
