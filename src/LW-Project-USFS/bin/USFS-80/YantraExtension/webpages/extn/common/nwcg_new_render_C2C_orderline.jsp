...
//Begin CR845 02012013 
            String strTotalLineList = resolveValue("xml:C2COrderLineList:/OrderLineList/@TotalLineList");
	               if((strTotalLineList != null) && (!strTotalLineList.equals(""))) {
	   	                 strTotalNumberOfRecords = strTotalLineList; 
                   } else {
//End CR845 02012013 
...
<!-- Begin CR817 added font-size:11px attribute in line below -->
	<td colspan="15" align="center" style="font-size:11px">	
<!-- End CR817 -->
