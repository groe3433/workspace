...
<script>
	...
	function processWOForDisposition(viewID, itemId, serviceItemId, workOrderStatus, qtyRequested, qtyAllocated, isTrackableItem) {
		...
		if (("REFURB-DEKITTING" == svcItemId && "Y" == isTrack) && ("1400" == wOStatus || qtyReq == 0) && (qtyReq - qtyAllc != 0)) {
		//if (("DEKITTING" == svcItemId)) {
			...
			if ("REFURB-DEKITTING" != svcItemId){
				alert("Service Item ID is not REFURB-DEKITTING");
			}
