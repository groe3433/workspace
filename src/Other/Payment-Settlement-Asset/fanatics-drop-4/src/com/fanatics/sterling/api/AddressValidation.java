...
import com.fanatics.sterling.stub.FanAddressValidationResponse;
...
private static YFCLogCategory logger= YFCLogCategory.instance(YFCLogCategory.class);
	...
	public Document invokeAddressValidationREST(YFSEnvironment yfsEnv, Document inXML){
		...
		String authType = YFSSystem.getProperty("fan.rest.addressval.authtype"); 
		String baseUrl = YFSSystem.getProperty("fan.rest.addressval.base.url"); 
		String username = YFSSystem.getProperty("fan.rest.addressval.user"); 
		String password = YFSSystem.getProperty("fan.rest.addressval.pwd"); 
		String path = YFSSystem.getProperty("fan.rest.addressval.path"); 
